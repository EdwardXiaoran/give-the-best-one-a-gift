...
public class LuaThread extends Thread implements LuaGcable, LuaMetaTable, Runnable {
    ...
    private void m2284a(byte[] bArr, Object... objArr) {
        try {
            ...
            throw new LuaException(m2278a(LloadBuffer) + ": " + this.f2627b.toString(-1));
        } catch (Exception e) {
            this.f2629d.sendError(toString(), e);
            quit();
        }
    ...
    private void m2286b(String str, Object... objArr) {
        ...
        throw new LuaException(m2278a(LloadFile) + ": " + this.f2627b.toString(-1));
    }
    ...
    private void m2287c(String str, Object... objArr) {
        ...
        throw new LuaException(m2278a(LloadString) + ": " + this.f2627b.toString(-1));
    }
    ...
    public void m2288d(String str, Object... objArr) {
        try {
            ...
            if (this.f2627b.isFunction(-1)) {
                ...
                if (pcall != 0) {
                    throw new LuaException(m2278a(pcall) + ": " + this.f2627b.toString(-1));
                }
            }
        } catch (LuaException e) {
            this.f2629d.sendError(toString() + " " + str, e);
        }
    }
