...
public class LuaBitmap {
    ...
    /* renamed from: a */
    private static int m2187a(BitmapFactory.Options options, int i, int i2) {
    ...
    /* renamed from: b */
    private static int m2188b(BitmapFactory.Options options, int i, int i2) {
        int i3;
    ...
    public static Bitmap getBitmap(LuaContext luaContext, String str) {
        Bitmap bitmap;
        Bitmap bitmap2;
        WeakReference weakReference = f2407a.get(str);
        ...
        if (str.toLowerCase().startsWith("http://") || str.toLowerCase().startsWith("https://")) {
            ...
            bitmap = getLocalBitmap(luaContext, luaContext.getLuaDir() + "/" + str);
        } else {
    ...
    public static void removeBitmap(Bitmap bitmap) {
        for (Map.Entry next : f2407a.entrySet()) {
            if (bitmap.equals(((WeakReference) next.getValue()).get())) {
                f2407a.remove(next.getKey());
                return;
            }
        }
    }
