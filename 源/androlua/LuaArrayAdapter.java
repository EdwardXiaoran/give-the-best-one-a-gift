    ...
    private class AsyncLoader extends Thread {
        ...
        public Drawable getBitmap(LuaContext luaContext, String str) {
            ...
            if (!LuaArrayAdapter.this.f2391h.containsKey(this.f2394b)) {
                start();
                LuaArrayAdapter.this.f2391h.put(this.f2394b, true);
            }
            ...
            try {
                ...
                if (drawable instanceof BitmapDrawable) {
                    ...
                    if (imageView.getScaleType() == ImageView.ScaleType.FIT_XY) {
                        imageView.setLayoutParams(new ViewGroup.LayoutParams(this.f2385b.getWidth(), (int) ((((float) this.f2385b.getWidth()) * ((float) height)) / ((float) width))));
                    }
                }
            } catch (Exception e) {
