...
public class LuaMultiAdapter extends BaseAdapter {
    ...
    private class AsyncLoader extends Thread {
        ...
        public Drawable getBitmap(LuaContext luaContext, String str) {
            ...
            if (!LuaMultiAdapter.this.f2555p.containsKey(this.f2559b)) {
                start();
                LuaMultiAdapter.this.f2555p.put(this.f2559b, true);
            }
    ...
    public LuaMultiAdapter(LuaContext luaContext, LuaTable<Integer, LuaTable<String, Object>> luaTable, LuaTable<Integer, LuaTable> luaTable2) {
        ...
        this.f2544e = luaTable == null ? new LuaTable<>(this.f2541b) : luaTable;
    ...
    private void m2247a(View view, Object obj) {
        ...
        try {
            if (obj instanceof LuaTable) {
                m2246a(view, (LuaTable<String, Object>) (LuaTable) obj);
    ...
    private int m2249b(Object obj, String str, Object obj2) {
        ...
        while (it.hasNext()) {
            ...
            if (parameterTypes.length == 1 && parameterTypes[0].isInterface()) {
                ...
                try {
                    next.invoke(obj, new Object[]{this.f2541b.getLuaObject(-1).createProxy(parameterTypes[0])});
                    return 1;
                } catch (Exception e) {
    ...
    public int getItemViewType(int i) {
        int intValue = ((Long) this.f2544e.get(Integer.valueOf(i + 1)).get("__type")).intValue() - 1;
        if (intValue < 0) {
            return 0;
        }
        return intValue;
    ...
    public android.view.View getView(int r10, android.view.View r11, android.view.ViewGroup r12) {
        ...
        L_0x00c8:
            ...
            r9.m2247a((android.view.View) r7, (java.lang.Object) r5)     // Catch:{ Exception -> 0x00f5 }
        L_0x00eb:
            java.lang.Object r5 = r6.getObject()     // Catch:{ Exception -> 0x00f5 }
            android.view.View r5 = (android.view.View) r5     // Catch:{ Exception -> 0x00f5 }
            r9.m2247a((android.view.View) r5, (java.lang.Object) r1)     // Catch:{ Exception -> 0x00f5 }
            goto L_0x00ad
        L_0x00f5:
            r1 = move-exception
    ...
    public void notifyDataSetChanged() {
        ...
        if (!this.f2553n) {
            ...
            new Handler().postDelayed(new Runnable() {
                public void run() {
                    boolean unused = LuaMultiAdapter.this.f2553n = false;
                }
            }, 500);
        }
    }
