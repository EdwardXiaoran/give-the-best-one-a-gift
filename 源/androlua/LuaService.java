...
public class LuaService extends Service implements LuaBroadcastReceiver.OnReceiveListener, LuaContext {
    ...
    public Object doAsset(String str, Object... objArr) {
        try {
            ...
            throw new LuaException(m2270a(LloadBuffer) + ": " + this.f2607h.toString(-1));
        } catch (Exception e) {
            sendMsg(e.getMessage());
            return null;
        }
    ...
    public Object doFile(String str, Object[] objArr) {
        try {
            ...
            throw new LuaException(m2270a(LloadFile) + ": " + this.f2607h.toString(-1));
        } catch (LuaException e) {
            sendMsg(e.getMessage());
            return null;
        }
    ...
    public Object doString(String str, Object... objArr) {
        try {
            ...
            throw new LuaException(m2270a(LloadString) + ": " + this.f2607h.toString(-1));
        } catch (LuaException e) {
            sendMsg(e.getMessage());
            return null;
        }
    ...
    public String getLuaExtDir(String str) {
        File file = new File(this.f2612m + "/" + str);
        if (file.exists() || file.mkdirs()) {
            return file.getAbsolutePath();
        }
        return null;
    ...
    public Object loadLib(String str) {
        ...
        if (!new File(this.f2611l + "/lib" + substring + ".so").exists()) {
            if (!new File(this.luaDir + "/lib" + substring + ".so").exists()) {
                throw new LuaException("can not find lib " + str);
            }
            m2275a(this.luaDir + "/lib" + substring + ".so", this.f2611l + "/lib" + substring + ".so");
        }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (this.f2607h == null) {
            ...
            this.f2604e = this.luaDir + "/?.lua;" + this.luaDir + "/lua/?.lua;" + this.luaDir + "/?/init.lua;" + this.f2604e;
    ...
    public Object runFunc(String str, Object... objArr) {
        ...
        try {
            ...
            throw new LuaException(m2270a(pcall) + ": " + this.f2607h.toString(-1));
        } catch (LuaException e) {
