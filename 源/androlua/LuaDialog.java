...
public class LuaDialog extends AlertDialog implements DialogInterface.OnClickListener {
    ...
    public void setItems(String[] strArr) {
        setAdapter(new ArrayListAdapter(this.f2457a, 17367043, new ArrayList(Arrays.asList(strArr))));
    ...
    public void setMultiChoiceItems(CharSequence[] charSequenceArr, int[] iArr) {
        setAdapter(new ArrayListAdapter(this.f2457a, 17367056, new ArrayList(Arrays.asList(charSequenceArr))));
    ...
    public void setSingleChoiceItems(CharSequence[] charSequenceArr, int i) {
        setAdapter(new ArrayListAdapter(this.f2457a, 17367055, new ArrayList(Arrays.asList(charSequenceArr))));
