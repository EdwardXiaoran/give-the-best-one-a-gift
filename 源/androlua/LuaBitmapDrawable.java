...
public class LuaBitmapDrawable extends Drawable implements LuaGcable, Runnable {
    ...
    /* renamed from: n */
    private GifDecoder.GifFrame f2423n;
    ...
    public LuaBitmapDrawable(LuaContext luaContext, String str) {
        ...
        if (str.toLowerCase().startsWith("http://") || str.toLowerCase().startsWith("https://")) {
            ...
            m2193a(!str.startsWith("/") ? luaContext.getLuaPath(str) : str);
        }
    }
    ...
    public void m2193a(final String str) {
        try {
            this.f2421l = new GifDecoder((InputStream) new FileInputStream(str), (GifDecoder.GifAction) new GifDecoder.GifAction() {
                public void parseOk(boolean z, int i) {
                    if (!z && i < 0) {
                        LuaBitmapDrawable.this.m2196b(str);
                    } else if (z && LuaBitmapDrawable.this.f2422m == null && LuaBitmapDrawable.this.f2421l.getFrameCount() > 1) {
                        GifDecoder unused = LuaBitmapDrawable.this.f2422m = LuaBitmapDrawable.this.f2421l;
                    }
                }
            });
            this.f2421l.start();
