...
public class LuaExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private class AsyncLoader extends Thread {
        ...
        public Drawable getBitmap(LuaContext luaContext, String str) {
            ...
            if (!LuaExpandableListAdapter.this.f2504q.containsKey(this.f2507b)) {
                start();
                LuaExpandableListAdapter.this.f2504q.put(this.f2507b, true);
            }
    ...
    public LuaExpandableListAdapter(LuaContext luaContext, LuaTable<Integer, LuaTable<String, Object>> luaTable, LuaTable<Integer, LuaTable<Integer, LuaTable<String, Object>>> luaTable2, LuaTable luaTable3, LuaTable luaTable4) {
        ...
        this.f2488a.setColorFilter(-1996488705, PorterDuff.Mode.SRC_ATOP);
        this.f2495h = luaTable3;
        this.f2496i = luaTable4;
        luaTable = luaTable == null ? new LuaTable<>(this.f2490c) : luaTable;
        luaTable2 = luaTable2 == null ? new LuaTable<>(this.f2490c) : luaTable2;
    ...
    private void m2219a(View view, Object obj) {
        ...
        if (obj instanceof LuaTable) {
            m2218a(view, (LuaTable<String, Object>) (LuaTable) obj);
    ...
    private int m2221b(Object obj, String str, Object obj2) {
        ...
        while (it.hasNext()) {
            ...
            if (parameterTypes.length == 1 && parameterTypes[0].isInterface()) {
                ...
                try {
                    next.invoke(obj, new Object[]{this.f2490c.getLuaObject(-1).createProxy(parameterTypes[0])});
                    return 1;
                } catch (Exception e) {
    ...
    public Object getChild(int i, int i2) {
        return this.f2493f.get(Integer.valueOf(i + 1)).get(Integer.valueOf(i2 + 1));
    }
    ...
    public android.view.View getChildView(int r7, int r8, boolean r9, android.view.View r10, android.view.ViewGroup r11) {
        ...
        L_0x0072:
            ...
            r6.m2219a((android.view.View) r11, (java.lang.Object) r8)     // Catch:{ Exception -> 0x0094 }
            goto L_0x0072
        L_0x0094:
            r8 = move-exception
    ...
    public int getChildrenCount(int i) {
        return this.f2493f.get(Integer.valueOf(i + 1)).length();
    }
    ...
    public GroupItem getGroupItem(int i) {
        return new GroupItem(this.f2493f.get(Integer.valueOf(i + 1)));
    }
    ...
    public android.view.View getGroupView(int r6, boolean r7, android.view.View r8, android.view.ViewGroup r9) {
        ...
        L_0x0067:
            ...
            r5.m2219a((android.view.View) r2, (java.lang.Object) r1)     // Catch:{ Exception -> 0x0089 }
            goto L_0x0067
        L_0x0089:
            r1 = move-exception
