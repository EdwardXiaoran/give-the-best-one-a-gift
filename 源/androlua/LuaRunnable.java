...
public class LuaRunnable extends Thread implements LuaGcable, LuaMetaTable, Runnable {
    ...
    public void m2260a(String str, Object... objArr) {
        try {
            ...
            luaContext.sendMsg(toString() + " " + e.getMessage());
            quit();
        }
    }
    ...
    private void m2261a(byte[] bArr, Object... objArr) {
        try {
            ...
            throw new LuaException(m2255a(LloadBuffer) + ": " + this.f2580b.toString(-1));
        } catch (Exception e) {
            this.f2582d.sendMsg(toString() + " " + e.getMessage());
            quit();
        }
    }
    ...
    private void m2263b(String str, Object... objArr) {
        ...
        throw new LuaException(m2255a(LloadFile) + ": " + this.f2580b.toString(-1));
    }
    ...
    private void m2264c(String str, Object... objArr) {
        ...
        throw new LuaException(m2255a(LloadString) + ": " + this.f2580b.toString(-1));
    }
    ...
    public void m2265d(String str, Object... objArr) {
        try {
            ...
            if (this.f2580b.isFunction(-1)) {
                ...
                if (pcall != 0) {
                    throw new LuaException(m2255a(pcall) + ": " + this.f2580b.toString(-1));
                }
            }
        } catch (LuaException e) {
            this.f2582d.sendMsg(str + " " + e.getMessage());
        }
    }
