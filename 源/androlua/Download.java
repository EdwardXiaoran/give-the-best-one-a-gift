...
public class Download {
    ...
    public void start(String str, String str2, String str3, String str4) {
        ...
        new AlertDialog.Builder(this.f2193a.getContext()).setTitle("Download").setMessage(this.f2199g).setView(this.f2194b).setPositiveButton("Download", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                String unused = Download.this.f2204l = Download.this.f2194b.getText().toString();
