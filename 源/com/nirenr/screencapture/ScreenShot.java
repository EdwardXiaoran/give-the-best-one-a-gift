...
public class ScreenShot {
    ...
    /* renamed from: e */
    private final VirtualDisplay.Callback f3438e;
    /* access modifiers changed from: private */
    ...
    public class SaveTask extends AsyncTask<Image, Void, Bitmap> {
        ...
        public Bitmap doInBackground(Image... imageArr) {
            ...
            image.close();
            Image unused = ScreenShot.this.f3440g = null;
            if (ScreenShot.this.f3439f != null) {
                ScreenShot.this.f3439f.onScreenCaptureDone(createBitmap2);
                ScreenCaptureListener unused2 = ScreenShot.this.f3439f = null;
            }
            return null;
        }
    ...
    private void m3302c() {
        ...
        ((WindowManager) this.f3437d.getSystemService("window")).getDefaultDisplay().getRealMetrics(displayMetrics);
    ...
    private void m3305f() {
        ...
        if (this.f3441i != null && this.f3442j == null) {
            try {
                this.f3442j = this.f3441i.createVirtualDisplay("screen-mirror", this.f3444l, this.f3445m, this.f3446n, 16, this.f3443k.getSurface(), this.f3438e, (Handler) null);
            } catch (Exception e) {
                C0029a.m806a(e);
            }
        }
    ...
    public void m3306g() {
        if (this.f3440g == null) {
            ...
            if (this.f3440g != null) {
                ...
                this.f3439f.onScreenCaptureDone((Bitmap) null);
                this.f3439f = null;
            }
        }
    }
    ...
    private Bitmap m3307h() {
        ...
        Image.Plane[] planes = this.f3440g.getPlanes();
        ByteBuffer buffer = planes[0].getBuffer();
        int pixelStride = planes[0].getPixelStride();
        Bitmap createBitmap = Bitmap.createBitmap(((planes[0].getRowStride() - (pixelStride * width)) / pixelStride) + width, height, Bitmap.Config.ARGB_8888);
        createBitmap.copyPixelsFromBuffer(buffer);
