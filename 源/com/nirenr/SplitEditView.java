...
public class SplitEditView extends LinearLayout implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private class EditDialog implements DialogInterface.OnClickListener {
        ...
        public void show() {
            this.f3431d = new AlertDialog.Builder(SplitEditView.this.f3419a).setTitle("输入内容").setView(this.f3430c).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).setPositiveButton(17039370, this).setCancelable(false).create();
