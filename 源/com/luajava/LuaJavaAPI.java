...
public final class LuaJavaAPI {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:51:0x00a9, code lost:
        m3267a(r9, r11, 3, (java.lang.Class) r0);
     */
    ...
    private static int m3261a(com.luajava.LuaState r9, java.lang.Object r10, java.lang.String r11) {
        ...
        L_0x00a2:
            ...
            r11.<init>((java.lang.Exception) r10)     // Catch:{ all -> 0x0006 }
            throw r11     // Catch:{ all -> 0x0006 }
        L_0x00a9:
            r10 = 3
            m3267a((com.luajava.LuaState) r9, (java.lang.String) r11, (int) r10, (java.lang.Class) r0)     // Catch:{ all -> 0x0006 }
        L_0x00ad:
            monitor-exit(r9)     // Catch:{ all -> 0x0006 }
            return r2
        L_0x00af:
                ...
                if (!z || Modifier.isStatic(next.getModifiers())) {
                    ...
                    if (parameterTypes.length == 1 && parameterTypes[0].isInterface()) {
                        ...
                        try {
                            ...
                            luaState.pop(1);
                            next.invoke(obj, new Object[]{createProxy});
                            return 1;
                        } catch (Exception e) {
    ...
    private static java.lang.Object m3265a(com.luajava.LuaState r3, java.lang.Class<?> r4, int r5, int r6) {
        ...
        L_0x0086:
            java.lang.Object r0 = m3264a((com.luajava.LuaState) r3, (java.lang.Class) r4, (int) r6)
            goto L_0x0135
        L_0x008c:
        ...
        L_0x009d:
            com.luajava.LuaObject r0 = r3.getLuaObject((int) r6)
            goto L_0x0135
        L_0x00a3:
        ...
        L_0x00f4:
            ...
            java.lang.Number r0 = com.luajava.LuaState.convertLuaNumber((java.lang.Long) r3, (java.lang.Class<?>) r4)
            goto L_0x0135
        L_0x0107:
            ...
            java.lang.Number r0 = com.luajava.LuaState.convertLuaNumber((java.lang.Double) r3, (java.lang.Class<?>) r4)
            goto L_0x0135
        L_0x011a:
            boolean r5 = r4.isPrimitive()
    ...
    private static String m3267a(LuaState luaState, String str, int i, Class cls) {
        throw new LuaException("bad argument to '" + str + "' (" + cls.getName() + " expected, got " + m3266a(luaState, i) + " value)");
    }

    /* renamed from: a */
    private static String m3268a(LuaState luaState, String str, int i, String str2) {
        throw new LuaException("bad argument #" + i + " to '" + str + "' (" + str2 + " expected, got " + m3266a(luaState, i + 1) + " value)");
    }
    ...
    private static int m3269b(com.luajava.LuaState r12, java.lang.Class<?> r13) {
        ...
        L_0x008d:
            ...
            r13.<init>((java.lang.String) r0)     // Catch:{ all -> 0x00dd }
    ...
    private static int m3270b(LuaState luaState, Object obj, String str, boolean z) {
        ...
        synchronized (luaState) {
            ...
            try {
                    ...
                    switch (type) {
                        case 3:
                            if (!luaState2.isInteger(-1)) {
                                Method method2 = f3383d.get(str4);
                                if (method2 != null) {
                                    objArr[0] = LuaState.convertLuaNumber(Double.valueOf(luaState2.toNumber(-1)), (Class<?>) method2.getParameterTypes()[0]);
                                }
                                method = method2;
                                c = 3;
                                break;
                            } else {
                                method = f3382c.get(str4);
                                if (method != null) {
                                    objArr[0] = LuaState.convertLuaNumber(Long.valueOf(luaState2.toInteger(-1)), (Class<?>) method.getParameterTypes()[0]);
                                }
                                c = 9;
                                break;
                            }
                        case 4:
                            Method method3 = f3381b.get(str4);
                            if (method3 != null) {
                ...
                ArrayList<Method> method4 = getMethod(obj.getClass(), str3, z2);
                StringBuilder sb = new StringBuilder();
                Iterator<Method> it = method4.iterator();
                while (it.hasNext()) {
                    Method next = it.next();
                    if (!z2 || Modifier.isStatic(next.getModifiers())) {
                        Class[] parameterTypes = next.getParameterTypes();
    ...
    /* JADX WARNING: Removed duplicated region for block: B:118:0x01f0 A[Catch:{ Exception -> 0x0124, Exception -> 0x003d, all -> 0x0277 }, DONT_GENERATE] */
    /* JADX WARNING: Removed duplicated region for block: B:120:0x01f3 A[Catch:{ Exception -> 0x0124, Exception -> 0x003d, all -> 0x0277 }] */
    ...
    public static int callMethod(long r19, java.lang.Object r21, java.lang.String r22) {
        ...
        L_0x0056:
            ...
            r1.<init>((java.lang.String) r2)     // Catch:{ all -> 0x0277 }
        ...
        L_0x009f:
            ...
            java.lang.Number r11 = com.luajava.LuaState.convertLuaNumber((java.lang.Long) r11, (java.lang.Class<?>) r12)     // Catch:{ all -> 0x0277 }
            r10[r8] = r11     // Catch:{ all -> 0x0277 }
            goto L_0x00fc
        L_0x00c6:
            r5 = 3
            ...
            java.lang.Class[] r12 = r7.getParameterTypes()     // Catch:{ all -> 0x0277 }
            r12 = r12[r8]     // Catch:{ all -> 0x0277 }
            java.lang.Number r11 = com.luajava.LuaState.convertLuaNumber((java.lang.Double) r11, (java.lang.Class<?>) r12)     // Catch:{ all -> 0x0277 }
            r10[r8] = r11     // Catch:{ all -> 0x0277 }
            goto L_0x00fc
        L_0x00e6:
        ...
        L_0x018e:
            ...
            r17 = r11
            int r11 = r8 + 1
            java.lang.Object r6 = m3265a((com.luajava.LuaState) r3, (java.lang.Class<?>) r9, (int) r6, (int) r11)     // Catch:{ Exception -> 0x01ab }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v11, resolved type: java.util.ArrayList<java.lang.reflect.Method>} */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.ArrayList<java.lang.reflect.Method> getMethod(java.lang.Class<?> r7, java.lang.String r8, boolean r9) {
        /*
            java.util.HashMap<java.lang.Class<?>, java.util.HashMap<java.lang.String, java.util.ArrayList<java.lang.reflect.Method>>> r0 = f3380a
            java.lang.Object r0 = r0.get(r7)
            java.util.HashMap r0 = (java.util.HashMap) r0
            if (r0 != 0) goto L_0x0014
            java.util.HashMap r0 = new java.util.HashMap
            r0.<init>()
            java.util.HashMap<java.lang.Class<?>, java.util.HashMap<java.lang.String, java.util.ArrayList<java.lang.reflect.Method>>> r1 = f3380a
            r1.put(r7, r0)
        L_0x0014:
            ...
            java.util.HashMap<java.lang.Class<?>, java.lang.reflect.Method[]> r1 = methodsMap
            java.lang.Object r1 = r1.get(r7)
            java.lang.reflect.Method[] r1 = (java.lang.reflect.Method[]) r1
            if (r1 != 0) goto L_0x0030
            java.lang.reflect.Method[] r1 = r7.getMethods()
            java.util.HashMap<java.lang.Class<?>, java.lang.reflect.Method[]> r3 = methodsMap
            r3.put(r7, r1)
        L_0x0030:
            int r7 = r1.length
            r3 = 0
        ...
        L_0x0083:
            ...
            java.util.ArrayList r7 = getMethod(r7, r8, r2)
        L_0x008f:
            return r7
        L_0x0090:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.luajava.LuaJavaAPI.getMethod(java.lang.Class, java.lang.String, boolean):java.util.ArrayList");
    }
    ...
    public static void javaGc(Object obj) {
        Bitmap bitmap;
        Log.i("javaGc: ", obj + BuildConfig.FLAVOR);
        if (obj != null) {
            try {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0095, code lost:
        r0 = r1.getMethod("is" + r9, new java.lang.Class[0]);
     */
    ...
    public static int javaGetter(com.luajava.LuaState r7, java.lang.Object r8, java.lang.String r9) {
        ...
        L_0x00ac:
            ...
            r7.pushString((java.lang.String) r8)     // Catch:{ all -> 0x00ca }
            goto L_0x00c1
        L_0x00be:
            r7.pushObjectValue(r8)     // Catch:{ all -> 0x00ca }
        L_0x00c1:
        ...
        L_0x00c3:
            ...
            r9.<init>((java.lang.Exception) r8)     // Catch:{ all -> 0x00ca }
    ...
    public static int javaLoadLib(long r3, java.lang.String r5, java.lang.String r6) {
        ...
        L_0x002e:
            ...
            r5.<init>((java.lang.String) r4)     // Catch:{ all -> 0x004a }
        ...
        L_0x004c:
            r4 = move-exception
            com.luajava.LuaException r5 = new com.luajava.LuaException     // Catch:{ all -> 0x004a }
            r5.<init>((java.lang.Exception) r4)     // Catch:{ all -> 0x004a }
            throw r5     // Catch:{ all -> 0x004a }
        L_0x0053:
            monitor-exit(r3)     // Catch:{ all -> 0x004a }
            throw r4
    ...
    public static int javaObjectLength(long j, Object obj) {
        ...
        synchronized (existingState) {
            try {
                existingState.pushInteger((long) (obj instanceof CharSequence ? ((CharSequence) obj).length() : obj instanceof Collection ? ((Collection) obj).size() : obj instanceof Map ? ((Map) obj).size() : Array.getLength(obj)));
            } catch (Exception e) {
                throw new LuaException(e);
            } catch (Throwable th) {
                throw th;
    ...
    public static int setArrayValue(long r3, java.lang.Object r5, int r6) {
        ...
        L_0x0020:
            ...
            m3267a((com.luajava.LuaState) r3, (java.lang.String) r5, (int) r0, (java.lang.Class) r4)     // Catch:{ all -> 0x009b }
            goto L_0x0065
        L_0x0045:
        ...
        L_0x0068:
            ...
            r1.append(r6)     // Catch:{ all -> 0x009b }
            java.lang.String r5 = r1.toString()     // Catch:{ all -> 0x009b }
            r4.<init>((java.lang.String) r5)     // Catch:{ all -> 0x009b }
    ...
    public static int setArrayValue(com.luajava.LuaState r4, java.lang.Object r5, int r6) {
        ...
        L_0x001c:
            ...
            r6 = 3
            m3267a((com.luajava.LuaState) r4, (java.lang.String) r5, (int) r6, (java.lang.Class) r0)     // Catch:{ all -> 0x0098 }
            goto L_0x0062
        L_0x0042:
        ...
        L_0x0065:
            ...
            r0.<init>((java.lang.String) r5)     // Catch:{ all -> 0x0098 }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x0051, code lost:
        m3267a(r4, r6, -1, (java.lang.Class) r0);
     */
    ...
    public static int setFieldValue(com.luajava.LuaState r4, java.lang.Object r5, java.lang.String r6) {
        ...
        L_0x004a:
            ...
            r6.<init>((java.lang.Exception) r5)     // Catch:{ all -> 0x0006 }
            throw r6     // Catch:{ all -> 0x0006 }
        L_0x0051:
            r5 = -1
            m3267a((com.luajava.LuaState) r4, (java.lang.String) r6, (int) r5, (java.lang.Class) r0)     // Catch:{ all -> 0x0006 }
        L_0x0055:
            monitor-exit(r4)     // Catch:{ all -> 0x0006 }
            return r2
        L_0x0057:
