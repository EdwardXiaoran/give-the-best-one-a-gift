...
class C0535s {
    ...
    private ArrayList<C0536t> m3225a(Context context, int i) {
        return Build.VERSION.SDK_INT >= 21 ? m3232c(context, i) : m3230b(context, i);
    }
    ...
    private void m3226a(Context context, ArrayList<C0536t> arrayList, boolean z) {
        ...
        try {
            ...
            Iterator<C0536t> it = arrayList.iterator();
            while (it.hasNext()) {
                JSONObject a = it.next().mo3395a();
                if (a != null) {
                    jSONArray.put(a);
                }
            }
    ...
    private void m3227a(Context context, boolean z, int i) {
        ArrayList<C0536t> a = m3225a(context, i);
        if (a != null && a.size() != 0) {
            if (z) {
                String b = a.get(0).mo3396b();
    ...
    private ArrayList<C0536t> m3232c(Context context, int i) {
        ...
        for (int i2 = 0; i2 < runningAppProcesses.size() && linkedHashMap.size() <= i; i2++) {
            ...
            if (!(!m3228a(runningAppProcessInfo.importance) || (strArr = runningAppProcessInfo.pkgList) == null || strArr.length == 0)) {
