...
class C0487bz implements Runnable {
    ...
    public void run() {
        if (this.f3243b.f3240f != null) {
            ...
            Timer unused = this.f3243b.f3240f = null;
        }
        SendStrategyEnum unused2 = this.f3243b.f3239e = SendStrategyEnum.values()[C0471bj.m2935a().mo3271a(this.f3242a)];
        int unused3 = this.f3243b.f3238d = C0471bj.m2935a().mo3275b(this.f3242a);
        boolean unused4 = this.f3243b.f3236b = C0471bj.m2935a().mo3281c(this.f3242a);
