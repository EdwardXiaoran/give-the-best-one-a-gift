...
public final class C0523g {
    ...
    private static java.lang.String m3170a(java.io.File r5) {
        ...
        L_0x002e:
            ...
            r1 = r0
        L_0x0030:
            m3184b((java.lang.Throwable) r5)     // Catch:{ all -> 0x003e }
            if (r1 == 0) goto L_0x003d
            r1.close()     // Catch:{ Exception -> 0x0039 }
            return r0
        L_0x0039:
            r5 = move-exception
            m3184b((java.lang.Throwable) r5)
        L_0x003d:
            return r0
        L_0x003e:
            r5 = move-exception
                    ...
                    try {
                        ...
                        if (bundle != null) {
                            ...
                            if (!TextUtils.isEmpty(string)) {
                                ...
                                C0525i iVar = new C0525i((C0524h) null);
                                iVar.f3334b = jSONObject.getInt("priority");
                                iVar.f3333a = next.activityInfo.applicationInfo;
                                if (this.f3329b.getPackageName().equals(next.activityInfo.applicationInfo.packageName)) {
                                    iVar.f3336d = true;
                                }
                                if (z) {
    ...
    private boolean m3175a(java.lang.String r7) {
        ...
        L_0x004b:
            r7 = move-exception
        L_0x004c:
            m3184b((java.lang.Throwable) r7)     // Catch:{ all -> 0x0049 }
    ...
    private boolean m3176a(String str, String str2) {
        try {
            return Settings.System.putString(this.f3329b.getContentResolver(), str, str2);
        } catch (Exception e) {
            m3184b((Throwable) e);
            return false;
        }
    ...
    private C0526j m3180b() {
        ...
        String str;
        String str2;
        List<C0525i> a = m3172a(new Intent("com.baidu.intent.action.GALAXY").setPackage(this.f3329b.getPackageName()), true);
        boolean z2 = false;
        if (a == null || a.size() == 0) {
            for (int i = 0; i < 3; i++) {
        ...
        if (a2 == null) {
            ...
            if (a3 != null) {
                ...
                for (C0525i next : a3) {
                    if (!next.f3336d) {
                        File file2 = new File(new File(next.f3333a.dataDir, str4), "libcuid.so");
                        if (file2.exists() && (a2 = C0526j.m3197a(m3192f(m3170a(file2)))) != null) {
                            break;
                        }
                    }
                }
    ...
    private String m3182b(String str) {
        try {
            return Settings.System.getString(this.f3329b.getContentResolver(), str);
        } catch (Exception e) {
            m3184b((Throwable) e);
            return null;
        }
    ...
    private static void m3183b(String str, String str2) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                fileWriter.write(C0461b.m2890a(C0434a.m2792a(f3327a, f3327a, (str + "=" + str2).getBytes()), "utf-8"));
                fileWriter.flush();
                fileWriter.close();
    ...
    private C0526j m3188d() {
        ...
        if (TextUtils.isEmpty(b)) {
            ...
            b = m3182b(C0488c.m3013a(("com.baidu" + b2 + b3).getBytes(), true));
        }
        if (TextUtils.isEmpty(b)) {
            return null;
        }
        C0526j jVar = new C0526j((C0524h) null);
        jVar.f3337a = b;
        jVar.f3338b = b2;
        return jVar;
    }
