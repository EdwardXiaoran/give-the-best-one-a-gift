    ...
    public void run() {
        try {
            ...
            if (currentTimeMillis - BottomReceiver.f3048b < 30000) {
                ...
                this.f3096c.mo3382b();
                C0517db unused = BottomReceiver.f3047a = null;
                return;
            }
            long unused2 = BottomReceiver.f3048b = currentTimeMillis;
            C0449ao.RECEIVER.mo3212a(this.f3094a);
            this.f3096c.mo3382b();
            C0517db unused3 = BottomReceiver.f3047a = null;
        } catch (Throwable th) {
            this.f3096c.mo3382b();
            C0517db unused4 = BottomReceiver.f3047a = null;
            throw th;
        }
    }
}
