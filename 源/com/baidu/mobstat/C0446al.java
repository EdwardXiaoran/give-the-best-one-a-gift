...
public class C0446al {
    ...
    /* renamed from: a */
    private static String f3081a = (Build.VERSION.SDK_INT < 9 ? "http://openrcv.baidu.com/1010/bplus.gif" : "https://openrcv.baidu.com/1010/bplus.gif");
    ...
    private String m2825a(Context context, String str, String str2) {
        ...
        try {
            ...
            C0465bd.m2914c("code: " + responseCode + "; len: " + contentLength);
            if (responseCode == 200) {
                if (contentLength == 0) {
                ...
                for (File file2 : listFiles) {
                    if (file2.isFile()) {
                        ...
                        if (!TextUtils.isEmpty(name) && name.startsWith("__send_log_data_")) {
                            ...
                            if (m2831b(context, C0507cs.m3087b(str))) {
                                C0507cs.m3090c(str);
                                i = 0;
                            } else {
                                i++;
    ...
    public void m2829a(String str) {
        C0507cs.m3085a("backups/system" + File.separator + "__send_log_data_" + System.currentTimeMillis(), str, false);
    }
