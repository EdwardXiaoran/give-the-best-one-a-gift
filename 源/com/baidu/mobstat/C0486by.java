...
class C0486by {
    ...
    public boolean m3002b(Context context, String str) {
        ...
        C0514cz.m3110a("send log data over. result = " + z + "; data=" + str);
        return z;
    }
    ...
    public void mo3326a(Context context, SendStrategyEnum sendStrategyEnum, int i, boolean z) {
        ...
        C0514cz.m3110a("sstype is:" + this.f3239e.name() + " And timeInterval is:" + this.f3238d + " And mOnlyWifi:" + this.f3236b);
    }

    /* renamed from: a */
    public void mo3327a(Context context, String str) {
        C0507cs.m3084a(context, Config.PREFIX_SEND_DATA + System.currentTimeMillis(), str, false);
    }
