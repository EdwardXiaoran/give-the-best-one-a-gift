...
class C0482bu {
    ...
    public synchronized void mo3313a(Context context, JSONObject jSONObject) {
        ...
        if (jSONObject.length() > 10) {
            C0514cz.m3110a("header has been installed; header is:" + jSONObject);
            return;
        }
    ...
    public synchronized void mo3315b(Context context, JSONObject jSONObject) {
        try {
            ...
            jSONObject.put(Config.PROCESS_CLASS, str);
            ...
            C0514cz.m3110a("header is: " + jSONObject.toString() + "; len: " + jSONObject.length());
