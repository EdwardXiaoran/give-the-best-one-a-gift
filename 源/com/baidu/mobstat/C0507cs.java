...
public final class C0507cs {
    ...
    /* renamed from: a */
    private static final Proxy f3317a = new Proxy(Proxy.Type.HTTP, new InetSocketAddress("10.0.0.172", 80));

    /* renamed from: b */
    private static final Proxy f3318b = new Proxy(Proxy.Type.HTTP, new InetSocketAddress("10.0.0.200", 80));
