...
public enum C0541y {
    ...
    private int m3249a(List<String> list, ArrayList<Long> arrayList, ArrayList<C0539w> arrayList2, int i, int i2) {
        ...
        while (c > 0) {
            ...
            ArrayList<C0539w> a = mo3408a(i2, i4);
            if (i4 == 0 && a.size() != 0) {
                arrayList2.add(a.get(0));
            }
            Iterator<C0539w> it = a.iterator();
            while (it.hasNext()) {
                C0539w next = it.next();
                long a2 = next.mo3397a();
                String b = next.mo3398b();
    ...
    private int m3250c() {
        ...
        L_0x0021:
            ...
            r0 = r2
        L_0x0025:
            com.baidu.mobstat.C0465bd.m2913b((java.lang.Throwable) r0)     // Catch:{ all -> 0x0018 }
            if (r1 == 0) goto L_0x002d
        L_0x002a:
            r1.close()
        L_0x002d:
    ...
    public synchronized int mo3406a(java.util.ArrayList<java.lang.Long> r7) {
        ...
        L_0x0052:
            r3 = 0
        L_0x0053:
            com.baidu.mobstat.C0465bd.m2913b((java.lang.Throwable) r7)     // Catch:{ all -> 0x004e }
    ...
    public synchronized long mo3407a(long r5, java.lang.String r7) {
        ...
        L_0x0015:
            ...
            long r5 = r3.mo3205a((java.lang.String) r5, (java.lang.String) r7)     // Catch:{ Exception -> 0x0025, all -> 0x0023 }
        ...
        L_0x002b:
            r5 = move-exception
        L_0x002c:
            com.baidu.mobstat.C0465bd.m2913b((java.lang.Throwable) r5)     // Catch:{ all -> 0x0028 }
    ...
    public synchronized java.util.ArrayList<com.baidu.mobstat.C0539w> mo3408a(int r4, int r5) {
        ...
        L_0x0016:
            ...
            return r0
        L_0x0018:
            java.util.ArrayList r4 = r2.mo3206a((int) r4, (int) r5)     // Catch:{ Exception -> 0x0025, all -> 0x0022 }
            if (r2 == 0) goto L_0x0034
            r2.close()     // Catch:{ all -> 0x003c }
            goto L_0x0034
        L_0x0022:
        ...
        L_0x002a:
            r4 = move-exception
        L_0x002b:
            com.baidu.mobstat.C0465bd.m2913b((java.lang.Throwable) r4)     // Catch:{ all -> 0x0028 }
    ...
    public synchronized List<String> mo3409a(int i) {
        ...
        int a2 = mo3406a((ArrayList<Long>) arrayList2);
