...
class C0471bj extends C0472bk {
    ...
    public String mo3282d(Context context) {
        return getString(context, "device_id_1", (String) null);
    }
    ...
    public String mo3285e(Context context) {
        return getString(context, "cuidsec_1", (String) null);
    }
    ...
    public String mo3287f(Context context) {
        return getString(context, "setchannelwithcodevalue", (String) null);
    }
    ...
    public String mo3290h(Context context) {
        return getString(context, "mtjsdkmacss2_1", (String) null);
    }
    ...
    public String mo3292j(Context context) {
        return getString(context, "mtjsdkmacsstv_1", (String) null);
    }

    /* access modifiers changed from: protected */
    /* renamed from: k */
    public String mo3293k(Context context) {
        return getString(context, "he.ext", (String) null);
    }
