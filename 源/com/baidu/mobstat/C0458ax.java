...
class C0458ax {
    ...
    private static synchronized dalvik.system.DexClassLoader m2856a(android.content.Context r5) {
        ...
        L_0x001c:
            ...
            com.baidu.mobstat.C0465bd.m2909a((java.lang.String) r5)     // Catch:{ all -> 0x0073 }
        ...
        L_0x006b:
            r5 = move-exception
            com.baidu.mobstat.C0465bd.m2910a((java.lang.Throwable) r5)     // Catch:{ all -> 0x0073 }
        L_0x006f:
            dalvik.system.DexClassLoader r5 = f3103a     // Catch:{ all -> 0x0073 }
            monitor-exit(r0)
            return r5
    ...
    public static java.lang.String m2862b(java.lang.String r6) {
        /*
            ...
            com.baidu.mobstat.C0465bd.m2912b((java.lang.String) r1)     // Catch:{ Exception -> 0x0047 }
        L_0x0024:
        ...
        L_0x0047:
            r1 = move-exception
        L_0x0048:
            com.baidu.mobstat.C0465bd.m2910a((java.lang.Throwable) r1)     // Catch:{ all -> 0x0045 }
            ...
            com.baidu.mobstat.C0465bd.m2909a((java.lang.String) r6)     // Catch:{ all -> 0x0045 }
    ...
    private static boolean m2864c(Context context, String str) {
        ...
        C0465bd.m2909a("remote.jar local file digest value digest = " + a);
        if (TextUtils.isEmpty(a)) {
            str2 = "remote.jar local file digest value fail";
        } else {
            String b = m2862b(str);
            C0465bd.m2909a("remote.jar local file digest value version = " + b);
            if (TextUtils.isEmpty(b)) {
                return false;
            }
            String d = m2865d(context, b);
            C0465bd.m2909a("remote.jar config digest value remoteJarMd5 = " + d);
