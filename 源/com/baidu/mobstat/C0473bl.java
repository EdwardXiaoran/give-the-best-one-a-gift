...
class C0473bl implements Thread.UncaughtExceptionHandler {

    /* renamed from: a */
    private static final C0473bl f3153a = new C0473bl();

    /* renamed from: b */
    private Thread.UncaughtExceptionHandler f3154b = null;
    ...
    public void mo3295a(long j, String str, String str2, int i) {
        ...
        if (this.f3155c != null && str != null && !str.trim().equals(BuildConfig.FLAVOR)) {
            try {
                ...
                C0507cs.m3084a(this.f3155c, Config.PREFIX_SEND_DATA + System.currentTimeMillis(), jSONObject3.toString(), false);
