...
public abstract class C0408b {
    ...
    private HashMap<C0409a, Integer> m2566a() {
        ...
        hashMap.put(C0409a.FOREGROUND, -16777216);
        hashMap.put(C0409a.BACKGROUND, -32);
        hashMap.put(C0409a.SELECTION_FOREGROUND, -32);
        hashMap.put(C0409a.SELECTION_BACKGROUND, -6832092);
        hashMap.put(C0409a.CARET_FOREGROUND, -32);
        hashMap.put(C0409a.CARET_BACKGROUND, -12537601);
        hashMap.put(C0409a.CARET_DISABLED, -8355712);
        hashMap.put(C0409a.LINE_HIGHLIGHT, 545818760);
        hashMap.put(C0409a.NON_PRINTING_GLYPH, -5592406);
        hashMap.put(C0409a.COMMENT, -12615841);
        hashMap.put(C0409a.KEYWORD, -3129123);
        hashMap.put(C0409a.NAME, -14008065);
        hashMap.put(C0409a.LITERAL, -10452737);
        hashMap.put(C0409a.STRING, -2276216);
        hashMap.put(C0409a.SECONDARY, -8355712);
        return hashMap;
    }
    ...
    public int mo2956a(int r2) {
        ...
        L_0x002e:
            int r2 = r1.mo2957a((com.p021b.p022a.p024b.C0408b.C0409a) r2)
            return r2
        */
    ...
    public int mo2957a(C0409a aVar) {
        Integer num = this.f2970a.get(aVar);
        if (num != null) {
            return num.intValue();
        }
        C0428q.m2726a("Color not specified for " + aVar);
        return 0;
    }
