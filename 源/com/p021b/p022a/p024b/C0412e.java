...
public class C0412e extends C0426o {
    ...
    private void m2570a(int i, int i2) {
        while (i < this.f2989h.size() && this.f2989h.get(i).intValue() <= i2) {
    ...
    private void m2571a(int i, int i2, int i3) {
        ...
        int intValue = this.f2989h.get(i).intValue();
        int i4 = i + 1;
        m2570a(i4, i2 - i3);
        m2572b(i4, i3);
    ...
    private void m2572b(int i, int i2) {
        while (i < this.f2989h.size()) {
            this.f2989h.set(i, Integer.valueOf(this.f2989h.get(i).intValue() + i2));
            i++;
        }
    }
    ...
    public String mo2965b(int i) {
        int c = mo2968c(i);
        return c == 0 ? new String() : subSequence(this.f2989h.get(i).intValue(), c).toString();
    }
    ...
    public void mo2966b() {
        ...
        if (!this.f2987f || m2575n()) {
            m2573b(1, 0, mo3054d());
        } else if (this.f2988g.getRowWidth() > 0) {
    ...
    public int mo2968c(int i) {
        ...
        return (i != this.f2989h.size() + -1 ? this.f2989h.get(i + 1).intValue() : mo3054d()) - this.f2989h.get(i).intValue();
    }
    ...
    public int mo2969d(int i) {
        ...
        return this.f2989h.get(i).intValue();
    }
    ...
    public int mo2970e(int i) {
        ...
        while (size >= i2) {
            int i3 = (i2 + size) / 2;
            int i4 = i3 + 1;
            int intValue = i4 < this.f2989h.size() ? this.f2989h.get(i4).intValue() : mo3054d();
            if (i >= this.f2989h.get(i3).intValue() && i < intValue) {
                return i3;
            }
            if (i >= intValue) {
                i2 = i4;
