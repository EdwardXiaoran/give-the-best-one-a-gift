...
public class C0429r {
    ...
    public int mo3081a() {
        ...
        C0431a aVar = this.f3036c.get(this.f3039f - 1);
        int i = aVar.f3043d;
        while (true) {
            C0431a aVar2 = this.f3036c.get(this.f3039f - 1);
            if (aVar2.f3043d != i) {
                break;
            }
            aVar2.mo3090a();
    ...
    public void mo3082a(int r4, int r5, long r6) {
        ...
        L_0x0022:
            ...
            int r2 = r3.f3038e
            r0.<init>(r4, r5, r2)
            r3.m2728a((com.p021b.p022a.p024b.C0429r.C0431a) r0)
    ...
    public int mo3083b() {
        ...
        C0431a aVar = this.f3036c.get(this.f3039f);
        int i = aVar.f3043d;
        while (true) {
            C0431a aVar2 = this.f3036c.get(this.f3039f);
            if (aVar2.f3043d != i) {
                break;
            }
            aVar2.mo3092b();
