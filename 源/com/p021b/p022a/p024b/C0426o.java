...
public class C0426o implements CharSequence {
    ...
    private void m2687a(int i, int i2) {
        C0424m mVar = this.f3029e.get(mo2965b(i).mo3047a());
    ...
    private C0424m mo2965b(int i) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            int a = this.f3029e.get(i3).mo3047a();
            i2 += a;
            if (i2 >= i) {
    ...
    private void m2690b(int i, int i2) {
        ...
        C0424m c = mo2968c(i);
        if (i2 == 1) {
            C0424m mVar = this.f3029e.get(c.mo3047a());
            if (mVar.mo3047a() > 1) {
            ...
            int b = i - c.mo3049b();
            C0424m mVar2 = this.f3029e.get(c.mo3047a());
            if (mVar2.mo3047a() > b) {
            ...
            if (i3 > 0) {
                int a = c.mo3047a();
                while (a >= 0) {
                    C0424m mVar3 = this.f3029e.get(a);
    ...
    public synchronized int mo3058h(int r3) {
        ...
        L_0x0006:
            ...
            int r0 = r2.m2686a((int) r3, (int) r1, (int) r0)     // Catch:{ all -> 0x002a }
            goto L_0x0021
        L_0x001b:
