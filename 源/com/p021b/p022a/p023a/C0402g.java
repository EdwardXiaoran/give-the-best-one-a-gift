...
public class C0402g extends GestureDetector.SimpleOnGestureListener {
    ...
    private void m2527c(android.view.MotionEvent r7) {
        ...
        L_0x0061:
            ...
            float r1 = r7.getX()
            int r1 = (int) r1
            int r1 = r6.mo2925a((int) r1)
            float r7 = r7.getY()
            int r7 = (int) r7
            int r7 = r6.mo2933b((int) r7)
            int r7 = r0.mo2753a((int) r1, (int) r7)
    ...
    public boolean onSingleTapUp(android.view.MotionEvent r6) {
        /*
            ...
            r6.mo2754a((boolean) r1)
            return r1
        L_0x000f:
            float r0 = r6.getX()
            int r0 = (int) r0
            int r0 = r5.mo2925a((int) r0)
            float r6 = r6.getY()
            int r6 = (int) r6
            int r6 = r5.mo2933b((int) r6)
            com.b.a.a.c r2 = r5.f2937c
            int r2 = r2.mo2753a((int) r0, (int) r6)
            com.b.a.a.c r3 = r5.f2937c
            boolean r3 = r3.isSelectText()
            if (r3 == 0) goto L_0x0064
            com.b.a.a.c r3 = r5.f2937c
            int r3 = r3.mo2755b((int) r0, (int) r6)
