...
public class LuaAdapter extends BaseAdapter implements Filterable {
    ...
    private class ArrayFilter extends Filter {
        ...
        public Filter.FilterResults performFiltering(CharSequence charSequence) {
            ...
            CharSequence unused = LuaAdapter.this.f2352i = charSequence;
    ...
    private class AsyncLoader extends Thread {
        ...
        public Drawable getBitmap(LuaContext luaContext, String str) {
            ...
            if (!LuaAdapter.this.f2362s.containsKey(this.f2369b)) {
                start();
                LuaAdapter.this.f2362s.put(this.f2369b, true);
            }
    ...
    public LuaAdapter(LuaContext luaContext, LuaTable<Integer, LuaTable<String, Object>> luaTable, LuaTable luaTable2) {
        ...
        this.f2361r = new Handler() {
            public void handleMessage(Message message) {
                ...
                try {
                    ...
                    LuaTable unused = LuaAdapter.this.f2350g = luaTable;
                    LuaAdapter.this.notifyDataSetChanged();
        ...
        this.f2350g = luaTable == null ? new LuaTable<>(this.f2346c) : luaTable;
    ...
    private void m2165a(View view, Object obj) {
        ...
        try {
            if (obj instanceof LuaTable) {
                m2164a(view, (LuaTable<String, Object>) (LuaTable) obj);
    ...
    private int m2167b(Object obj, String str, Object obj2) {
        ...
        while (it.hasNext()) {
            ...
            if (parameterTypes.length == 1 && parameterTypes[0].isInterface()) {
                ...
                try {
                    next.invoke(obj, new Object[]{this.f2346c.getLuaObject(-1).createProxy(parameterTypes[0])});
                    return 1;
                } catch (Exception e) {
    ...
    public android.view.View getView(int r9, android.view.View r10, android.view.ViewGroup r11) {
        ...
        L_0x0087:
            ...
            r8.m2165a((android.view.View) r6, (java.lang.Object) r4)     // Catch:{ Exception -> 0x00c6 }
        L_0x00bc:
            java.lang.Object r4 = r5.getObject()     // Catch:{ Exception -> 0x00c6 }
            android.view.View r4 = (android.view.View) r4     // Catch:{ Exception -> 0x00c6 }
            r8.m2165a((android.view.View) r4, (java.lang.Object) r3)     // Catch:{ Exception -> 0x00c6 }
            goto L_0x0087
        L_0x00c6:
            r3 = move-exception
    ...
    public void notifyDataSetChanged() {
        ...
        if (!this.f2360q) {
            ...
            new Handler().postDelayed(new Runnable() {
                public void run() {
                    boolean unused = LuaAdapter.this.f2360q = false;
                }
            }, 500);
        }
    }
