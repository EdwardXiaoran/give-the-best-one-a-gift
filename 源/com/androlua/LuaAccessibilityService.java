...
public class LuaAccessibilityService extends AccessibilityService {
        ...
        new AsyncTask<String, String, HashMap<String, ComponentName>>() {
            ...
            public void onPostExecute(HashMap<String, ComponentName> hashMap) {
                ...
                if (hashMap != null && !hashMap.isEmpty()) {
                    HashMap unused = LuaAccessibilityService.this.f2272e = hashMap;
                }
            }
    ...
    public boolean deleteApp(String str) {
        this.f2272e.clear();
        m2144c();
        ComponentName componentName = this.f2272e.get(str.toLowerCase());
            ...
            if (!str2.isEmpty()) {
                if (str2.charAt(0) != '%') {
                    ...
                    for (AccessibilityNodeInfo next : rootInActiveWindow.findAccessibilityNodeInfosByText(str2)) {
                        String trim = (next.getText() + BuildConfig.FLAVOR).trim();
                        String trim2 = (next.getContentDescription() + BuildConfig.FLAVOR).trim();
                        if (!z || !z2) {
                            if (z) {
    ...
    public void onAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        } else if (this.f2271c.containsKey("LuaAccessibilityService") && (luaTable = (LuaTable) this.f2271c.get("LuaAccessibilityService")) != null) {
            try {
    ...
    public void onCreate() {
        ...
        if (this.f2271c.containsKey("LuaAccessibilityService") && (luaTable = (LuaTable) this.f2271c.get("LuaAccessibilityService")) != null) {
            try {
    ...
    public void startScreenshot() {
        this.f2276i = new ScreenShot(this, (VirtualDisplay.Callback) null);
    }
