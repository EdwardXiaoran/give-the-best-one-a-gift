...
public class Ticker {
    ...
    private void m2324a() {
        ...
        this.f2735c = new Thread() {
            public void run() {
                boolean unused = Ticker.this.f2738f = true;
                while (Ticker.this.f2738f) {
                    long currentTimeMillis = System.currentTimeMillis();
                    if (!Ticker.this.f2737e) {
                        long unused2 = Ticker.this.f2739g = currentTimeMillis - Ticker.this.f2740h;
                    }
                    if (currentTimeMillis - Ticker.this.f2739g >= Ticker.this.f2736d) {
                        long unused3 = Ticker.this.f2739g = currentTimeMillis;
