...
public class LuaEditor extends C0383c {
    ...
    public void setBackgoudColor(int i) {
        getColorScheme().mo2958a(C0408b.C0409a.BACKGROUND, i);
    }

    public void setBasewordColor(int i) {
        getColorScheme().mo2958a(C0408b.C0409a.NAME, i);
    }

    public void setCommentColor(int i) {
        getColorScheme().mo2958a(C0408b.C0409a.COMMENT, i);
    }
    ...
    public void setKeywordColor(int i) {
        getColorScheme().mo2958a(C0408b.C0409a.KEYWORD, i);
    }
    ...
    public void setStringColor(int i) {
        getColorScheme().mo2958a(C0408b.C0409a.STRING, i);
    }
    ...
    public void setTextColor(int i) {
        getColorScheme().mo2958a(C0408b.C0409a.FOREGROUND, i);
    }

    public void setTextHighlightColor(int i) {
        getColorScheme().mo2958a(C0408b.C0409a.SELECTION_BACKGROUND, i);
    }

    public void setUserwordColor(int i) {
        getColorScheme().mo2958a(C0408b.C0409a.LITERAL, i);
    }
    ...
    public void startFindMode() {
        startActionMode(new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
                ...
                this.f2484d = new EditText(LuaEditor.this.f2471v) {
                    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
                        if (charSequence.length() > 0) {
                            int unused = C03332.this.f2483c = 0;
                            C03332.this.m2215a();
                        }
                    }
                };
                ...
                this.f2484d.setOnEditorActionListener(new TextView.OnEditorActionListener() {
                    public boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                        C03332.this.m2215a();
                        return true;
                    }
                });
                this.f2484d.setLayoutParams(new RadioGroup.LayoutParams(LuaEditor.this.getWidth() / 3, -1));
        ...
        startActionMode(new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
                ...
                this.f2478c = new EditText(LuaEditor.this.f2471v) {
                    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
                        if (charSequence.length() > 0) {
                            int unused = C03301.this.f2477b = 0;
                            C03301.this.m2212a();
                        }
                    }
                };
                ...
                this.f2478c.setOnEditorActionListener(new TextView.OnEditorActionListener() {
                    public boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                        C03301.this.m2212a();
                        return true;
                    }
                });
                this.f2478c.setLayoutParams(new RadioGroup.LayoutParams(LuaEditor.this.getWidth() / 3, -1));
