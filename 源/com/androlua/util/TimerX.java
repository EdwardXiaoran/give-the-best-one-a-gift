...
public class TimerX {
        ...
        public void finalize() {
            try {
                synchronized (this.f2813a) {
                    boolean unused = this.f2813a.f2815b = true;
                    this.f2813a.notify();
                }
                super.finalize();
            } catch (Throwable th) {
    ...
    private static final class TimerImpl extends Thread {
        ...
        public int purge() {
            ...
            int unused = this.f2816c.f2820d = 0;
        ...
        public void run() {
            ...
            L_0x0043:
                ...
                com.androlua.util.TimerX$TimerImpl$TimerHeap r4 = r10.f2816c     // Catch:{ all -> 0x00b2 }
                int r5 = r4.m2380a((com.androlua.util.TimerTaskX) r2)     // Catch:{ all -> 0x00b2 }
            L_0x005a:
                ...
                int r1 = r1.m2380a((com.androlua.util.TimerTaskX) r2)     // Catch:{ all -> 0x00b2 }
            ...
            L_0x0089:
                ...
                r2.f2806d = r6     // Catch:{ all -> 0x00b2 }
            L_0x0094:
                r10.m2376a((com.androlua.util.TimerTaskX) r2)     // Catch:{ all -> 0x00b2 }
                goto L_0x009a
            L_0x0098:
