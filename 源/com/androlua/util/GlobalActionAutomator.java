...
public class GlobalActionAutomator {
    ...
    private boolean m2368a(GestureDescription gestureDescription) {
        ...
        return this.f2786a.dispatchGesture(gestureDescription, new AccessibilityService.GestureResultCallback() {
    ...
    private boolean m2371b(GestureDescription gestureDescription) {
        ...
        this.f2786a.dispatchGesture(gestureDescription, new AccessibilityService.GestureResultCallback() {
            public void onCancelled(GestureDescription gestureDescription) {
    ...
    public boolean gesture(long j, long j2, int[]... iArr) {
        return gestures(new GestureDescription.StrokeDescription(m2364a(iArr), j, j2));
    }

    public void gestureAsync(long j, long j2, int[]... iArr) {
        gesturesAsync(new GestureDescription.StrokeDescription(m2364a(iArr), j, j2));
    }
    ...
    public void gesturesAsync(GestureDescription.StrokeDescription... strokeDescriptionArr) {
        if (this.f2786a != null) {
            ...
            this.f2786a.dispatchGesture(builder.build(), (AccessibilityService.GestureResultCallback) null, (Handler) null);
        }
    }
