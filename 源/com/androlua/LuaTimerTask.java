...
public class LuaTimerTask extends TimerTaskX {
    ...
    private void m2294a(byte[] bArr, Object... objArr) {
        ...
        throw new LuaException(m2292a(LloadBuffer) + ": " + this.f2641a.toString(-1));
    }
    ...
    private void m2296b(String str, Object... objArr) {
        ...
        throw new LuaException(m2292a(LloadFile) + ": " + this.f2641a.toString(-1));
    }
    ...
    private void m2297c(String str, Object... objArr) {
        ...
        throw new LuaException(m2292a(LloadString) + ": " + this.f2641a.toString(-1));
    }
    ...
    private void m2298d(String str, Object... objArr) {
        try {
            ...
            if (this.f2641a.isFunction(-1)) {
                ...
                if (pcall != 0) {
                    throw new LuaException(m2292a(pcall) + ": " + this.f2641a.toString(-1));
                }
            }
        } catch (LuaException e) {
            this.f2642g.sendError(toString() + " " + str, e);
        }
    }
