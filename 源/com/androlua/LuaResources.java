...
public class LuaResources extends Resources implements LuaMetaTable {
    ...
    public boolean getBoolean(int i) {
        Boolean bool = this.f2576j.get(Integer.valueOf(i));
    ...
    public Drawable getDrawable(int i) {
        Drawable drawable = this.f2569c.get(Integer.valueOf(i));
    ...
    public Typeface getFont(int i) {
        Typeface typeface = this.f2573g.get(Integer.valueOf(i));
    ...
    public int[] getIntArray(int i) {
        int[] iArr = this.f2572f.get(Integer.valueOf(i));
        return iArr != null ? iArr : this.f2578l.getIntArray(i);
    }

    public int getInteger(int i) {
        Integer num = this.f2574h.get(Integer.valueOf(i));
    ...
    public String[] getStringArray(int i) {
        String[] strArr = this.f2571e.get(Integer.valueOf(i));
        return strArr != null ? strArr : this.f2578l.getStringArray(i);
    }

    public CharSequence getText(int i) {
        String str = this.f2568b.get(Integer.valueOf(i));
