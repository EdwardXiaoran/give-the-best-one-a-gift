...
public class LuaWebView extends WebView implements LuaGcable {
    ...
    private class Download implements DownloadListener {
        ...
        public long m2317a(boolean z) {
            if (LuaWebView.this.f2664a == null) {
                ...
                DownloadBroadcastReceiver unused = LuaWebView.this.f2664a = new DownloadBroadcastReceiver();
            ...
            request.setDestinationInExternalPublicDir(new File(LuaWebView.this.f2667d.getLuaExtDir()).getName() + "/" + "Download", this.f2693h);
        ...
        public void onDownloadStart(String str, String str2, String str3, String str4, long j) {
            ...
            if (j > 1048576) {
                ...
                new AlertDialog.Builder(LuaWebView.this.f2667d).setTitle("Download").setMessage("Type: " + str4 + "\nSize: " + str6).setView(this.f2686a).setPositiveButton("Download", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialogInterface, int i) {
                        String unused = Download.this.f2693h = Download.this.f2686a.getText().toString();
                        long unused2 = Download.this.m2317a(false);
                    }
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        String unused = Download.this.f2693h = Download.this.f2686a.getText().toString();
                        long unused2 = Download.this.m2317a(true);
                    }
                }).create().show();
            }
    ...
    class LuaWebChromeClient extends WebChromeClient {
        ...
        public boolean onJsAlert(WebView webView, String str, String str2, final JsResult jsResult) {
            new AlertDialog.Builder(LuaWebView.this.f2667d).setTitle(str).setMessage(str2).setPositiveButton(17039370, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
                    jsResult.confirm();
                }
        ...
        public boolean onJsConfirm(WebView webView, String str, String str2, final JsResult jsResult) {
            AlertDialog.Builder builder = new AlertDialog.Builder(LuaWebView.this.f2667d);
        ...
        public void openFileChooser(ValueCallback<Uri> valueCallback, String str) {
            if (LuaWebView.this.f2672i == null) {
                ValueCallback unused = LuaWebView.this.f2672i = valueCallback;
    ...
    public LuaWebView(LuaActivity luaActivity) {
        ...
        this.f2668e = new ProgressBar(luaActivity, (AttributeSet) null, 16842872);
        this.f2668e.setLayoutParams(new AbsoluteLayout.LayoutParams(-1, (int) TypedValue.applyDimension(1, 2.0f, this.f2669f), 0, 0));
        addView(this.f2668e);
    ...
    public void onScrollChanged(int i, int i2, int i3, int i4) {
        AbsoluteLayout.LayoutParams layoutParams = (AbsoluteLayout.LayoutParams) this.f2668e.getLayoutParams();
        layoutParams.x = i;
        layoutParams.y = i2;
    ...
    public void openFile(String str) {
        if (this.f2670g == null) {
            ...
            this.f2671h.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                    String charSequence = ((TextView) view).getText().toString();
                    if (charSequence.equals("../")) {
                        String unused = LuaWebView.this.f2673j = new File(LuaWebView.this.f2673j).getParent() + "/";
                        LuaWebView.this.openFile(LuaWebView.this.f2673j);
                        return;
                    }
                    String str = LuaWebView.this.f2673j + charSequence;
                    if (new File(str).isDirectory()) {
                        String unused2 = LuaWebView.this.f2673j = str;
                        LuaWebView.this.openFile(LuaWebView.this.f2673j);
                        return;
                    }
                    LuaWebView.this.f2672i.onReceiveValue(Uri.parse(str));
                }
            });
        }
        ...
        if (list != null) {
            ...
            for (String str2 : list) {
                if (new File(this.f2673j + str2).isDirectory()) {
                    arrayList.add(str2 + "/");
                }
            }
            for (String str3 : list) {
                if (new File(this.f2673j + str3).isFile()) {
                    arrayList.add(str3);
                }
            }
        }
