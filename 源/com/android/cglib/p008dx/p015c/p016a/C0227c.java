...
public final class C0227c extends C0301o implements Comparable<C0227c> {
    ...
    public int compareTo(C0227c cVar) {
        Iterator<C0225a> it = this.f1735b.values().iterator();
        Iterator<C0225a> it2 = cVar.f1735b.values().iterator();
    ...
    public String toString() {
        ...
        boolean z = true;
        for (C0225a next : this.f1735b.values()) {
            if (z) {
                z = false;
            } else {
                sb.append(", ");
            }
            sb.append(next.mo1218a_());
        }
        sb.append("}");
        return sb.toString();
    }
