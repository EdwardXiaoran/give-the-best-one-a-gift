...
public final class C0225a extends C0301o implements C0304r, Comparable<C0225a> {
    ...
    public int compareTo(C0225a aVar) {
        ...
        Iterator<C0228d> it = this.f1727c.values().iterator();
        Iterator<C0228d> it2 = aVar.f1727c.values().iterator();
    ...
    public String mo1218a_() {
        ...
        sb.append(" {");
        boolean z = true;
        for (C0228d next : this.f1727c.values()) {
            if (z) {
                z = false;
            } else {
                sb.append(", ");
            }
            sb.append(next.mo1535a().mo1218a_());
            sb.append(": ");
            sb.append(next.mo1536b().mo1218a_());
        }
        sb.append("}");
        return sb.toString();
    }
