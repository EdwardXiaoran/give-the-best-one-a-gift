...
public final class C0244m implements C0284d, C0304r, Comparable<C0244m> {
    ...
    public static C0244m m1722a(int i, C0284d dVar) {
        return m1728c(i, dVar, (C0239h) null);
    }
    ...
    public boolean m1729d(int i, C0284d dVar, C0239h hVar) {
        if (this.f1772c != i || !this.f1773d.equals(dVar)) {
            return false;
        }
        if (this.f1774e != hVar) {
            return this.f1774e != null && this.f1774e.equals(hVar);
        }
        return true;
    }
    ...
    public boolean mo1587a(C0244m mVar) {
        return mo1590b(mVar) && this.f1772c == mVar.f1772c;
    }
    ...
    public boolean mo1590b(C0244m mVar) {
        if (mVar != null && this.f1773d.mo1589b().equals(mVar.f1773d.mo1589b())) {
            return this.f1774e == mVar.f1774e || (this.f1774e != null && this.f1774e.equals(mVar.f1774e));
        }
        return false;
    }
