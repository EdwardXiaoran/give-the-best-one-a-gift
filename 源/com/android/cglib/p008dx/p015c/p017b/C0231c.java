...
public final class C0231c extends C0299m {
    ...
    private static class C0232a implements C0235f.C0237b {
    ...
    /* renamed from: a */
    public void mo1553a(C0235f.C0237b bVar) {
        int a = mo1772a();
        for (int i = 0; i < a; i++) {
    ...
    public C0230b mo1555b(int i) {
        ...
        throw new IllegalArgumentException("no such label: " + C0295i.m2048c(i));
    }
