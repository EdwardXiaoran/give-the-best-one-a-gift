...
public final class C0252s {
    ...
    /* renamed from: a */
    public static final C0252s f2000a = new C0252s((C0277v) null, -1, -1);
    ...
    public boolean mo1642b(C0252s sVar) {
        if (this.f2003d != sVar.f2003d) {
            return false;
        }
        if (this.f2001b != sVar.f2001b) {
            return this.f2001b != null && this.f2001b.equals(sVar.f2001b);
        }
        return true;
    }
