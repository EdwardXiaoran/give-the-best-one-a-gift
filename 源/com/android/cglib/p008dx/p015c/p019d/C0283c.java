...
public final class C0283c implements C0284d, Comparable<C0283c> {
    ...
    public String mo1728f() {
        if (this.f2144O == null) {
            if (!mo1733j()) {
                throw new IllegalArgumentException("not an object type: " + this.f2141L);
            }
    ...
    public C0283c mo1735l() {
        if (this.f2145P == null) {
            this.f2145P = m1967b(new C0283c('[' + this.f2141L, 9));
        }
        return this.f2145P;
    }
    ...
    public C0283c mo1736m() {
        if (this.f2146Q == null) {
            if (this.f2141L.charAt(0) != '[') {
                throw new IllegalArgumentException("not an array type: " + this.f2141L);
            }
