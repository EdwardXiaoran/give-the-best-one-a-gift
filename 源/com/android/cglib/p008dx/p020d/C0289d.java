...
public final class C0289d implements C0286a, C0291e {
    ...
    public void mo1747a(int i) {
        if (this.f2153c != i) {
            throw new C0293g("expected cursor " + i + "; actual value: " + this.f2153c);
        }
    }
    ...
    public void mo1739a(int i, String str) {
        if (this.f2155e != null) {
            ...
            int b = size == 0 ? 0 : this.f2155e.get(size - 1).mo1766b();
            if (b <= this.f2153c) {
                b = this.f2153c;
            }
    ...
    public void mo1750a(Writer writer) {
        ...
        while (i3 < this.f2153c && i2 < size) {
            C0290a aVar = this.f2155e.get(i2);
            int a2 = aVar.mo1764a();
            if (i3 < a2) {
        ...
        while (i2 < size) {
            b.write(this.f2155e.get(i2).mo1768c());
            i2++;
        }
        sVar.mo1806c();
    }
    ...
    public void mo1743c() {
        int size;
        if (this.f2155e != null && (size = this.f2155e.size()) != 0) {
            this.f2155e.get(size - 1).mo1765a(this.f2153c);
        }
    }
