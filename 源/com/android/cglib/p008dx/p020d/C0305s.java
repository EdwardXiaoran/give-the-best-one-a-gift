...
public final class C0305s {
    ...
    private void m2093d() {
        int indexOf;
        while (true) {
            int indexOf2 = this.f2177c.indexOf("\n");
            if (indexOf2 >= 0 && (indexOf = this.f2178d.indexOf("\n")) >= 0) {
                if (indexOf2 != 0) {
                    this.f2175a.write(this.f2177c.substring(0, indexOf2));
                }
                if (indexOf != 0) {
                    m2091a(this.f2175a, this.f2176b - indexOf2);
                    this.f2175a.write(this.f2178d.substring(0, indexOf));
                }
                this.f2175a.write(10);
                this.f2177c.delete(0, indexOf2 + 1);
                this.f2178d.delete(0, indexOf + 1);
            } else {
                return;
            }
        }
