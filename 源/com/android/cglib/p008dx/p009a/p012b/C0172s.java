...
public final class C0172s extends C0128ab {
    ...
    public C0171r mo1506a(C0265j jVar) {
        ...
        mo1401j();
        C0171r rVar = this.f1372a.get(jVar);
        if (rVar != null) {
            return rVar;
        }
    ...
    public C0176w mo1507a(C0255a aVar) {
        ...
        mo1400i();
        C0176w wVar = this.f1372a.get((C0265j) aVar);
        if (wVar != null) {
            return wVar;
        }
    ...
    public void mo1508a(C0286a aVar) {
        ...
        if (aVar.mo1741a()) {
            aVar.mo1739a(4, "field_ids_size:  " + C0295i.m2044a(size));
            aVar.mo1739a(4, "field_ids_off:   " + C0295i.m2044a(g));
        }
        aVar.mo1755d(size);
        aVar.mo1755d(g);
    }
