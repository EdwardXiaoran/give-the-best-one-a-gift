...
public final class C0161j {
    ...
    /* renamed from: o */
    private final C0105p.C0107b[] f1340o;
    ...
    public C0161j(C0113u uVar, C0105p pVar, C0165l lVar, int i, int i2, boolean z, C0274s sVar) {
        ...
        this.f1340o = new C0105p.C0107b[i2];
    }
    ...
    private int m1528a(int i) {
        ...
        while (i < a && this.f1327b.mo1215a(i).mo1288a() == this.f1334i) {
            int i2 = i + 1;
            C0105p.C0107b a2 = this.f1327b.mo1215a(i);
            int g = a2.mo1300g();
            C0105p.C0107b bVar = this.f1340o[g];
            if (a2 != bVar) {
                this.f1340o[g] = a2;
                if (a2.mo1294c()) {
                ...
                } else if (a2.mo1292b() != C0105p.C0106a.END_REPLACED) {
                    m1547e(a2);
                }
            }
            i = i2;
    ...
    /* renamed from: a */
    private int m1530a(int i, ArrayList<C0113u.C0114a> arrayList) {
        int size = arrayList.size();
        while (i < size && arrayList.get(i).mo1321a() == this.f1334i) {
            m1533a(arrayList.get(i));
            i++;
        }
        return i;
    }
    ...
    /* renamed from: a */
    private String m1531a(C0105p.C0107b bVar) {
    ...
    /* renamed from: a */
    private void m1533a(C0113u.C0114a aVar) {
        int a = aVar.mo1322b().mo1640a();
        int a2 = aVar.mo1321a();
        int i = a - this.f1335j;
        int i2 = a2 - this.f1334i;
        if (i2 < 0) {
    ...
    /* renamed from: a */
    private void m1536a(ArrayList<C0113u.C0114a> arrayList, ArrayList<C0105p.C0107b> arrayList2) {
        C0105p.C0107b bVar;
        boolean z = (this.f1336k == null && this.f1337l == null) ? false : true;
        int g = this.f1328c.mo1760g();
        if (arrayList.size() > 0) {
            this.f1335j = arrayList.get(0).mo1322b().mo1640a();
        }
        this.f1328c.mo1756e(this.f1335j);
        if (z) {
            m1532a(this.f1328c.mo1760g() - g, "line_start: " + this.f1335j);
        }
        int d = m1543d();
        C0282b c = this.f1332g.mo1714c();
        int a = c.mo1772a();
        if (!this.f1333h) {
            Iterator<C0105p.C0107b> it = arrayList2.iterator();
            while (true) {
                if (!it.hasNext()) {
                    break;
                }
                C0105p.C0107b next = it.next();
                if (d == next.mo1300g()) {
                    this.f1340o[d] = next;
                    break;
                }
        ...
        int g2 = this.f1328c.mo1760g();
        this.f1328c.mo1756e(a);
        if (z) {
            m1532a(this.f1328c.mo1760g() - g2, String.format("parameters_size: %04x", new Object[]{Integer.valueOf(a)}));
        }
        int i = d;
        for (int i2 = 0; i2 < a; i2++) {
            C0283c b = c.mo1723b(i2);
            int g3 = this.f1328c.mo1760g();
            Iterator<C0105p.C0107b> it2 = arrayList2.iterator();
            while (true) {
                if (!it2.hasNext()) {
                    bVar = null;
                    break;
            ...
            if (z) {
                m1532a(this.f1328c.mo1760g() - g3, "parameter " + ((bVar == null || bVar.mo1297e() != null) ? "<unnamed>" : bVar.mo1296d().mo1218a_()) + " " + "v" + i);
            }
            i += b.mo1729g();
        }
        for (C0105p.C0107b bVar2 : this.f1340o) {
            if (!(bVar2 == null || bVar2.mo1297e() == null)) {
                m1545d(bVar2);
            }
        }
    }
    ...
    /* renamed from: b */
    private void m1538b(C0105p.C0107b bVar) {
        int g = this.f1328c.mo1760g();
    ...
    /* renamed from: b */
    private byte[] m1539b() {
        ArrayList<C0113u.C0114a> c = m1540c();
        m1536a(c, m1546e());
        ...
        while (true) {
            ...
            int a3 = i2 < size ? c.get(i2).mo1321a() : Integer.MAX_VALUE;
    ...
    /* renamed from: c */
    private ArrayList<C0113u.C0114a> m1540c() {
        int a = this.f1326a == null ? 0 : this.f1326a.mo1772a();
        ArrayList<C0113u.C0114a> arrayList = new ArrayList<>(a);
        for (int i = 0; i < a; i++) {
            arrayList.add(this.f1326a.mo1215a(i));
        }
        Collections.sort(arrayList, new Comparator<C0113u.C0114a>() {
            /* renamed from: a */
            public int compare(C0113u.C0114a aVar, C0113u.C0114a aVar2) {
    ...
    /* renamed from: c */
    private void m1542c(C0105p.C0107b bVar) {
        if (bVar.mo1297e() != null) {
            m1545d(bVar);
            return;
        }
    ...
    /* renamed from: d */
    private void m1545d(C0105p.C0107b bVar) {
        int g = this.f1328c.mo1760g();
    ...
    /* renamed from: e */
    private ArrayList<C0105p.C0107b> m1546e() {
        ArrayList<C0105p.C0107b> arrayList = new ArrayList<>(this.f1332g.mo1714c().mo1772a());
        int d = m1543d();
        ...
        Collections.sort(arrayList, new Comparator<C0105p.C0107b>() {
            /* renamed from: a */
            public int compare(C0105p.C0107b bVar, C0105p.C0107b bVar2) {
    ...
    /* renamed from: e */
    private void m1547e(C0105p.C0107b bVar) {
        int g = this.f1328c.mo1760g();
