...
public final class C0158h extends C0149as {
    ...
    private int m1513a(C0283c cVar, int i, int i2) {
        C0157g gVar = this.f1316a.get(cVar);
        if (gVar == null || gVar.mo1512f()) {
            return i;
        }
        if (i2 < 0) {
    ...
    public void mo1452a(C0286a aVar) {
        ...
        if (aVar.mo1741a()) {
            aVar.mo1739a(4, "class_defs_size: " + C0295i.m2044a(size));
            aVar.mo1739a(4, "class_defs_off:  " + C0295i.m2044a(g));
        }
        aVar.mo1755d(size);
        aVar.mo1755d(g);
    }
