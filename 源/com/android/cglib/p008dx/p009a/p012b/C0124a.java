...
public final class C0124a extends C0136ag {
    ...
    public void mo1341a(C0286a aVar, String str) {
        aVar.mo1739a(0, str + "visibility: " + this.f1239b.mo1523c().mo1218a_());
        aVar.mo1739a(0, str + "type: " + this.f1239b.mo1522b().mo1218a_());
        for (C0228d next : this.f1239b.mo1525d()) {
            C0277v a = next.mo1535a();
            C0255a b = next.mo1536b();
            aVar.mo1739a(0, str + a.mo1218a_() + ": " + C0151au.m1454b(b));
        }
    }
    ...
    public void mo1342a_(C0165l lVar, C0286a aVar) {
        ...
        if (a) {
            aVar.mo1739a(0, mo1382g() + " annotation");
            aVar.mo1739a(1, "  visibility: VISBILITY_" + c);
        }
        switch (c) {
            case BUILD:
                aVar.mo1753b(0);
