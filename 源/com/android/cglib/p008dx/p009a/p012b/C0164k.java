...
public class C0164k extends C0136ag {
    ...
    public void mo1339a(C0140ak akVar, int i) {
        try {
            this.f1344b = m1553a(akVar.mo1396e(), (String) null, (PrintWriter) null, (C0286a) null, false);
            mo1375a(this.f1344b.length);
        } catch (RuntimeException e) {
            throw C0293g.m2033a(e, "...while placing debug info for " + this.f1346d.mo1218a_());
        }
    }
    ...
    public void mo1462a(C0165l lVar, C0286a aVar, String str) {
        m1553a(lVar, str, (PrintWriter) null, aVar, false);
    }
    ...
    public void mo1342a_(C0165l lVar, C0286a aVar) {
        if (aVar.mo1741a()) {
            aVar.mo1740a(mo1382g() + " debug info");
            m1553a(lVar, (String) null, (PrintWriter) null, aVar, true);
        }
