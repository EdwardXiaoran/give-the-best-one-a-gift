...
public final class C0145ao extends C0149as {
    ...
    public C0144an mo1412a(C0144an anVar) {
        ...
        C0144an anVar2 = this.f1281a.get(c);
        if (anVar2 != null) {
            return anVar2;
        }
    ...
    public C0176w mo1414a(C0255a aVar) {
        ...
        mo1400i();
        C0176w wVar = this.f1281a.get((C0277v) aVar);
        if (wVar != null) {
            return wVar;
        }
    ...
    public int mo1415b(C0277v vVar) {
        ...
        mo1400i();
        C0144an anVar = this.f1281a.get(vVar);
        if (anVar != null) {
    ...
    public void mo1416b(C0286a aVar) {
        ...
        if (aVar.mo1741a()) {
            aVar.mo1739a(4, "string_ids_size: " + C0295i.m2044a(size));
            aVar.mo1739a(4, "string_ids_off:  " + C0295i.m2044a(g));
        }
        aVar.mo1755d(size);
        aVar.mo1755d(g);
    }
