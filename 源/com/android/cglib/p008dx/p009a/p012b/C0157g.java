...
public final class C0157g extends C0176w {
    ...
    public void mo1347a(C0165l lVar, C0286a aVar) {
        ...
        if (a) {
            aVar.mo1739a(0, mo1514h() + ' ' + this.f1308a.mo1218a_());
            StringBuilder sb = new StringBuilder();
            sb.append("  class_idx:           ");
            sb.append(C0295i.m2044a(b));
            aVar.mo1739a(4, sb.toString());
            aVar.mo1739a(4, "  access_flags:        " + C0229a.m1658a(this.f1309b));
            StringBuilder sb2 = new StringBuilder();
            sb2.append("  superclass_idx:      ");
            sb2.append(C0295i.m2044a(b2));
            sb2.append(" // ");
            sb2.append(this.f1310c == null ? "<none>" : this.f1310c.mo1218a_());
            aVar.mo1739a(4, sb2.toString());
            aVar.mo1739a(4, "  interfaces_off:      " + C0295i.m2044a(b3));
            if (b3 != 0) {
                C0285e c = this.f1311d.mo1423c();
                int a2 = c.mo1738a();
                for (int i2 = 0; i2 < a2; i2++) {
                    aVar.mo1739a(0, "    " + c.mo1215a(i2).mo1218a_());
                }
            }
            StringBuilder sb3 = new StringBuilder();
            sb3.append("  source_file_idx:     ");
            sb3.append(C0295i.m2044a(i));
            sb3.append(" // ");
            sb3.append(this.f1312e == null ? "<none>" : this.f1312e.mo1218a_());
            aVar.mo1739a(4, sb3.toString());
            aVar.mo1739a(4, "  annotations_off:     " + C0295i.m2044a(e));
            aVar.mo1739a(4, "  class_data_off:      " + C0295i.m2044a(e2));
            aVar.mo1739a(4, "  static_values_off:   " + C0295i.m2044a(b4));
        }
        aVar.mo1755d(b);
