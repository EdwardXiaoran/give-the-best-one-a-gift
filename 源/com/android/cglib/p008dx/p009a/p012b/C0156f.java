...
public final class C0156f extends C0136ag {
    ...
    private static void m1487a(C0165l lVar, C0286a aVar, String str, int i) {
        if (aVar.mo1741a()) {
            aVar.mo1740a(String.format("  %-21s %08x", new Object[]{str + "_size:", Integer.valueOf(i)}));
        }
        aVar.mo1756e(i);
    }
    ...
    private void m1489b(C0165l lVar, C0286a aVar) {
        ...
        if (a) {
            aVar.mo1739a(0, mo1382g() + " class data for " + this.f1300a.mo1218a_());
        }
        ...
        m1488a(lVar, aVar, "static_fields", (ArrayList<? extends C0168o>) this.f1301b);
        m1488a(lVar, aVar, "instance_fields", (ArrayList<? extends C0168o>) this.f1303d);
        m1488a(lVar, aVar, "direct_methods", (ArrayList<? extends C0168o>) this.f1304e);
        m1488a(lVar, aVar, "virtual_methods", (ArrayList<? extends C0168o>) this.f1305f);
        if (a) {
            aVar.mo1743c();
        }
    }
    ...
    private C0257c m1490h() {
        ...
        while (size > 0) {
            C0255a aVar = this.f1302c.get(this.f1301b.get(size - 1));
        ...
        C0257c.C0258a aVar2 = new C0257c.C0258a(size);
        for (int i = 0; i < size; i++) {
            C0167n nVar = this.f1301b.get(i);
            C0255a aVar3 = this.f1302c.get(nVar);
            if (aVar3 == null) {
    ...
    public void mo1340a(C0165l lVar) {
        if (!this.f1301b.isEmpty()) {
            mo1443d();
            Iterator<C0167n> it = this.f1301b.iterator();
            while (it.hasNext()) {
                it.next().mo1487a(lVar);
            }
        }
        if (!this.f1303d.isEmpty()) {
            Collections.sort(this.f1303d);
            Iterator<C0167n> it2 = this.f1303d.iterator();
            while (it2.hasNext()) {
                it2.next().mo1487a(lVar);
            }
        }
        if (!this.f1304e.isEmpty()) {
            Collections.sort(this.f1304e);
            Iterator<C0169p> it3 = this.f1304e.iterator();
            while (it3.hasNext()) {
                it3.next().mo1495a(lVar);
            }
        }
        if (!this.f1305f.isEmpty()) {
            Collections.sort(this.f1305f);
            Iterator<C0169p> it4 = this.f1305f.iterator();
            while (it4.hasNext()) {
                it4.next().mo1495a(lVar);
            }
        }
    }
