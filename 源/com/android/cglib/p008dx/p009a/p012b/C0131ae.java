...
public final class C0131ae extends C0128ab {
    ...
    public C0130ad mo1360a(C0259d dVar) {
        ...
        mo1401j();
        C0130ad adVar = this.f1246a.get(dVar);
        if (adVar != null) {
            return adVar;
        }
    ...
    public C0176w mo1361a(C0255a aVar) {
        ...
        mo1400i();
        C0176w wVar = this.f1246a.get((C0259d) aVar);
        if (wVar != null) {
            return wVar;
        }
    ...
    public void mo1363a(C0286a aVar) {
        ...
        if (aVar.mo1741a()) {
            aVar.mo1739a(4, "method_ids_size: " + C0295i.m2044a(size));
            aVar.mo1739a(4, "method_ids_off:  " + C0295i.m2044a(g));
        }
        aVar.mo1755d(size);
        aVar.mo1755d(g);
    }
