...
public final class C0179z extends C0136ag {
    ...
    public void mo1342a_(C0165l lVar, C0286a aVar) {
        ...
        if (aVar.mo1741a()) {
            aVar.mo1739a(0, mo1382g() + ' ' + this.f1402a.mo1517c() + " map");
            aVar.mo1739a(2, "  type:   " + C0295i.m2048c(b) + " // " + this.f1402a.toString());
            aVar.mo1739a(2, "  unused: 0");
            StringBuilder sb = new StringBuilder();
            sb.append("  size:   ");
            sb.append(C0295i.m2044a(this.f1406e));
            aVar.mo1739a(4, sb.toString());
            aVar.mo1739a(4, "  offset: " + C0295i.m2044a(g));
        }
        aVar.mo1754c(b);
        aVar.mo1754c(0);
