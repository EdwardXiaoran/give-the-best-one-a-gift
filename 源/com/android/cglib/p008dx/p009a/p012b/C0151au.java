...
public final class C0151au {
    ...
    public static void m1452a(C0165l lVar, C0225a aVar) {
        ...
        for (C0228d next : aVar.mo1525d()) {
            g.mo1413a(next.mo1535a());
            m1453a(lVar, next.mo1536b());
        }
    }
    ...
    public static void m1453a(C0165l lVar, C0255a aVar) {
        if (aVar instanceof C0256b) {
            ...
            C0257c.C0258a b = ((C0257c) aVar).mo1654b();
            int a = b.mo1772a();
            for (int i = 0; i < a; i++) {
    ...
    public static String m1454b(C0255a aVar) {
        ...
        return aVar.mo1649e() + ' ' + aVar.mo1218a_();
    }
    ...
    public void mo1427a(C0225a aVar, boolean z) {
        ...
        if (z2) {
            ...
            aVar2.mo1740a("  type_idx: " + C0295i.m2044a(b2) + " // " + b.mo1218a_());
        }
        ...
        if (z2) {
            ...
            aVar3.mo1740a("  size: " + C0295i.m2044a(size));
        }
        this.f1287b.mo1756e(size);
        int i = 0;
        for (C0228d next : d) {
            C0277v a = next.mo1535a();
            int b3 = g.mo1415b(a);
            C0255a b4 = next.mo1536b();
            if (z2) {
                C0286a aVar4 = this.f1287b;
                aVar4.mo1739a(0, "  elements[" + i + "]:");
                i++;
                C0286a aVar5 = this.f1287b;
                aVar5.mo1740a("    name_idx: " + C0295i.m2044a(b3) + " // " + a.mo1218a_());
            }
            this.f1287b.mo1756e(b3);
            if (z2) {
                C0286a aVar6 = this.f1287b;
                aVar6.mo1740a("    value: " + m1454b(b4));
            }
            mo1428a(b4);
        }
        if (z2) {
    ...
    public void mo1428a(com.android.cglib.p008dx.p015c.p018c.C0255a r4) {
        ...
        L_0x0030:
            ...
            r3.mo1427a((com.android.cglib.p008dx.p015c.p016a.C0225a) r4, (boolean) r1)
            return
        L_0x003f:
            com.android.cglib.dx.d.a r2 = r3.f1287b
            r2.mo1753b(r0)
            com.android.cglib.dx.c.c.c r4 = (com.android.cglib.p008dx.p015c.p018c.C0257c) r4
            r3.mo1429a((com.android.cglib.p008dx.p015c.p018c.C0257c) r4, (boolean) r1)
            return
        L_0x004a:
        ...
        L_0x0071:
            ...
            int r4 = r1.mo1420b((com.android.cglib.p008dx.p015c.p018c.C0278w) r4)
            goto L_0x008a
        L_0x007e:
            com.android.cglib.dx.a.b.l r1 = r3.f1286a
            com.android.cglib.dx.a.b.ao r1 = r1.mo1473g()
            com.android.cglib.dx.c.c.v r4 = (com.android.cglib.p008dx.p015c.p018c.C0277v) r4
            int r4 = r1.mo1415b((com.android.cglib.p008dx.p015c.p018c.C0277v) r4)
        L_0x008a:
            long r1 = (long) r4
            goto L_0x00a6
        L_0x008c:
    ...
    public void mo1429a(C0257c cVar, boolean z) {
        boolean z2 = z && this.f1287b.mo1741a();
        C0257c.C0258a b = cVar.mo1654b();
        int a = b.mo1772a();
        if (z2) {
            C0286a aVar = this.f1287b;
            aVar.mo1740a("  size: " + C0295i.m2044a(a));
        }
        ...
        for (int i = 0; i < a; i++) {
            ...
            if (z2) {
                C0286a aVar2 = this.f1287b;
                aVar2.mo1740a("  [" + Integer.toHexString(i) + "] " + m1454b(a2));
            }
            mo1428a(a2);
        }
        if (z2) {
