...
public abstract class C0097h {
    ...
    public static C0120x m1099a(C0252s sVar, C0244m mVar, C0244m mVar2) {
        ...
        int e = mVar.mo1596e();
        return new C0120x((mVar2.mo1596e() | e) < 16 ? j ? C0100k.f1161i : z ? C0100k.f1052c : C0100k.f1158f : e < 256 ? j ? C0100k.f1162j : z ? C0100k.f1105d : C0100k.f1159g : j ? C0100k.f1163k : z ? C0100k.f1157e : C0100k.f1160h, sVar, C0247n.m1754a(mVar, mVar2));
    }
    ...
    public final String mo1257a(String str, int i, boolean z) {
        ...
        String str2 = str + mo1269l() + ": ";
        int length = str2.length();
        return C0305s.m2090a(str2, length, BuildConfig.FLAVOR, a, i == 0 ? a.length() : i - length);
    }
    ...
    public final String toString() {
        ...
        if (this.f913d.mo1772a() != 0) {
            stringBuffer.append(this.f913d.mo1775b(" ", ", ", (String) null));
            z = true;
        } else {
            z = false;
        }
