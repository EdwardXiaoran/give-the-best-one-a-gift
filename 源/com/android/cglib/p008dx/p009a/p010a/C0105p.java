...
public final class C0105p extends C0294h {
    ...
    public static class C0107b implements Comparable<C0107b> {
        ...
        public int compareTo(C0107b bVar) {
            ...
            boolean c = mo1294c();
            return c != bVar.mo1294c() ? c ? 1 : -1 : this.f1192c.compareTo(bVar.f1192c);
        }
        ...
        public boolean equals(Object obj) {
            return (obj instanceof C0107b) && compareTo((C0107b) obj) == 0;
        }
        ...
        public String toString() {
            return Integer.toHexString(this.f1190a) + " " + this.f1191b + " " + this.f1192c;
        }
    }
    ...
    public static class C0108c {
        ...
        private void m1208a(int i, int i2) {
            ...
            } else if (z || i2 >= this.f1197d.length) {
                int i3 = i2 + 1;
        ...
        private void m1210b(int i, C0106a aVar, C0244m mVar) {
            ...
            if (i2 >= 0) {
                C0107b bVar = this.f1194a.get(i2);
        ...
        private boolean m1211c(int i, C0244m mVar) {
            ...
            while (true) {
                ...
                C0107b bVar = this.f1194a.get(size);
                if (bVar != null) {
                    if (bVar.mo1288a() != i) {
                        return false;
                    }
            ...
            this.f1196c.mo1623b(mVar);
            C0107b bVar2 = null;
            this.f1194a.set(size, (Object) null);
            this.f1195b++;
            int e = mVar.mo1596e();
            while (true) {
                size--;
        ...
        public C0105p mo1303a() {
            ...
            if (size == i) {
                ...
                Iterator<C0107b> it = this.f1194a.iterator();
                int i2 = 0;
                while (it.hasNext()) {
                    C0107b next = it.next();
                    if (next != null) {
        ...
        public void mo1304a(int i, C0244m mVar) {
            ...
            C0244m a2;
            int e = mVar.mo1596e();
            C0244m a3 = m1207a(mVar);
            m1208a(i, e);
            C0244m a4 = this.f1196c.mo1618a(e);
            if (!a3.mo1587a(a4)) {
                C0244m a5 = this.f1196c.mo1619a(a3);
                if (a5 != null) {
                    m1210b(i, C0106a.END_MOVED, a5);
                }
                int i2 = this.f1197d[e];
                if (a4 != null) {
                    m1209a(i, C0106a.END_REPLACED, a4);
                } else if (i2 >= 0) {
                    C0107b bVar = this.f1194a.get(i2);
                    if (bVar.mo1288a() == i) {
                        if (bVar.mo1291a(a3)) {
                            this.f1194a.set(i2, (Object) null);
                            this.f1195b++;
                            this.f1196c.mo1624c(a3);
                            this.f1197d[e] = -1;
                            return;
                        }
                ...
                if (e > 0 && (a2 = this.f1196c.mo1618a(e - 1)) != null && a2.mo1603j()) {
                    m1210b(i, C0106a.END_CLOBBERED_BY_NEXT, a2);
                }
                if (a3.mo1603j() && (a = this.f1196c.mo1618a(e + 1)) != null) {
                    m1210b(i, C0106a.END_CLOBBERED_BY_PREV, a);
                }
                m1209a(i, C0106a.START, a3);
            }
        }
