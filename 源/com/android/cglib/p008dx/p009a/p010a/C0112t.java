...
public final class C0112t {
    ...
    /* renamed from: a */
    private static void m1233a(C0094f fVar, C0095g.C0096a aVar) {
        int a;
        C0255a b = fVar.mo1241b();
        int a2 = aVar.mo1255a(b);
        if (a2 >= 0) {
            fVar.mo1240a(a2);
        }
        if ((b instanceof C0273r) && (a = aVar.mo1255a(((C0273r) b).mo1685g())) >= 0) {
            fVar.mo1242b(a);
        }
    }
    ...
    private static void m1234a(HashSet<C0255a> hashSet, C0097h hVar) {
        ...
        } else if (hVar instanceof C0109q) {
    ...
    private void m1236a(C0099j[] jVarArr) {
        ...
        while (true) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                C0097h hVar = this.f1205c.get(i3);
    ...
    private int m1238b(C0099j[] jVarArr) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            C0097h hVar = this.f1205c.get(i2);
    ...
    private C0099j m1242d(C0097h hVar) {
        ...
        throw new C0292f("No expanded opcode for " + hVar);
    }
    ...
    private ArrayList<C0097h> m1243d(C0099j[] jVarArr) {
        ...
        for (int i = 0; i < size; i++) {
            C0097h hVar2 = this.f1205c.get(i);
            C0099j g = hVar2.mo1264g();
            C0099j jVar = jVarArr[i];
            C0097h hVar3 = null;
            if (jVar != null) {
                hVar = null;
                ...
                jVar = m1242d(hVar2);
                BitSet c = jVar.mo1279c().mo1206c(hVar2);
                C0097h b = hVar2.mo1258b(c);
                hVar = hVar2.mo1259c(c);
                hVar2 = hVar2.mo1261d(c);
                hVar3 = b;
            }
            if (hVar3 != null) {
                arrayList.add(hVar3);
    ...
    private C0099j[] m1244e() {
        ...
        for (int i = 0; i < size; i++) {
            jVarArr[i] = this.f1205c.get(i).mo1264g();
        }
        return jVarArr;
    }
    ...
    /* renamed from: a */
    public void mo1314a(C0095g.C0096a aVar) {
        Iterator<C0097h> it = this.f1205c.iterator();
        while (it.hasNext()) {
            C0097h next = it.next();
            if (next instanceof C0094f) {
                m1233a((C0094f) next, aVar);
            }
        }
    }
