...
public final class C0098i extends C0294h {
    ...
    public static C0098i m1122a(ArrayList<C0097h> arrayList, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            iVar.mo1272a(i2, arrayList.get(i2));
        }
        iVar.mo1799e();
        return iVar;
    }
    ...
    public void mo1273a(C0286a aVar) {
        ...
        while (i < a) {
            ...
            try {
                ...
                throw C0293g.m2033a(e, "...while writing " + hVar2);
            }
        }
        int g2 = (aVar.mo1760g() - g) / 2;
        if (g2 != mo1274b()) {
            throw new RuntimeException("write length mismatch; expected " + mo1274b() + " but actually wrote " + g2);
        }
    }
