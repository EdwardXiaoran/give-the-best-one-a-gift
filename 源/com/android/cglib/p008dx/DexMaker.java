...
public final class DexMaker {
    ...
    static class C0051b {
        ...
        public C0169p mo1152a(C0123b bVar) {
            return new C0169p(this.f823a.f855f, this.f824b, C0116w.m1263a(new C0250q(this.f825c.mo1112c(), 0), 1, (C0240i) null, this.f825c.mo1111b(), bVar), C0282b.f2078a);
        }
    ...
    private static class C0052c {
        ...
        public C0157g mo1155a() {
            if (!this.f827b) {
                throw new IllegalStateException("Undeclared type " + this.f826a + " declares members: " + this.f832g.keySet() + " " + this.f833h.keySet());
            }
            ...
            for (C0051b next : this.f833h.values()) {
                C0169p a = next.mo1152a(bVar);
                if (next.mo1154b()) {
                    gVar.mo1446a(a);
                } else {
                    gVar.mo1447b(a);
            ...
            for (C0050a next2 : this.f832g.values()) {
                C0167n a2 = next2.mo1150a();
                if (next2.mo1151b()) {
                    gVar.mo1445a(a2, (C0255a) Constants.m836a(next2.f822c));
                } else {
                    gVar.mo1444a(a2);
                }
            }
    ...
    private C0052c m837a(TypeId<?> typeId) {
        C0052c cVar = this.f819a.get(typeId);
        if (cVar != null) {
            return cVar;
        }
    ...
    public void declare(TypeId<?> typeId, String str, int i, TypeId<?> typeId2, TypeId<?>... typeIdArr) {
        ...
        if ((i & -1042) != 0) {
            ...
            boolean unused = a.f827b = true;
            int unused2 = a.f828c = i;
            TypeId unused3 = a.f829d = typeId2;
            String unused4 = a.f830e = str;
            TypeList unused5 = a.f831f = new TypeList(typeIdArr);
        }
    }
