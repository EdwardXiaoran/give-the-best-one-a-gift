...
public final class Code {
    ...
    private <T> Local<T> m820a(Local<?> local, TypeId<T> typeId) {
        ...
        throw new IllegalArgumentException("requested " + typeId + " but was " + local.f846a);
    }
    ...
    private C0282b m823a(List<TypeId<?>> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            bVar.mo1720a(i, list.get(i).f858b);
        }
        return bVar;
    }
        ...
        if (b != 6) {
            switch (b) {
                ...
                case 4:
                    ...
                    m825a(label, (List<Label>) Collections.emptyList());
                    return;
                default:
            ...
            m825a((Label) null, (List<Label>) new ArrayList(this.f811j));
        }
    }

    /* renamed from: a */
    private <D, R> void m829a(C0249p pVar, MethodId<D, R> methodId, Local<? super R> local, Local<? extends D> local2, Local<?>... localArr) {
        m827a((C0235f) new C0253t(pVar, this.f809h, m821a((Local<?>) local2, localArr), this.f812k, methodId.f855f));
        if (local != null) {
            m826a((Local<?>) local, false);
        }
    }

    /* renamed from: d */
    private void m830d() {
        Iterator<Label> it = this.f803b.iterator();
        int i = 0;
        while (it.hasNext()) {
            Label next = it.next();
            if (next.mo1162a()) {
    ...
    public void mo1106a() {
        ...
        int i2 = i;
        for (Local next : this.f807f) {
            C0267l a2 = C0267l.m1882a(i2 - i);
            i2 += next.mo1166a(i2);
            arrayList.add(new C0241j(C0251r.m1789b((C0284d) next.f846a.f858b), this.f809h, next.mo1167b(), C0247n.f1778a, a2));
        }
        this.f803b.get(0).f839a.addAll(0, arrayList);
    }
    ...
    public C0231c mo1112c() {
        ...
        for (int i = 0; i < this.f803b.size(); i++) {
            cVar.mo1552a(i, this.f803b.get(i).mo1164c());
        }
        return cVar;
    }
    ...
    public void cast(Local<?> local, Local<?> local2) {
        if (local2.getType().f858b.mo1733j()) {
            m827a((C0235f) new C0253t(C0251r.f1958ch, this.f809h, C0247n.m1753a(local2.mo1167b()), this.f812k, local.f846a.f859c));
            m826a(local, true);
            return;
        }
    ...
    public <T> Local<T> getParameter(int i, TypeId<T> typeId) {
        ...
        return m820a(this.f807f.get(i), typeId);
    }
    ...
    public <D, V> void iget(FieldId<D, V> fieldId, Local<V> local, Local<D> local2) {
        m827a((C0235f) new C0253t(C0251r.m1816n((C0284d) local.f846a.f858b), this.f809h, C0247n.m1753a(local2.mo1167b()), this.f812k, fieldId.f838e));
        m826a((Local<?>) local, true);
    }

    public void instanceOfType(Local<?> local, Local<?> local2, TypeId<?> typeId) {
        m827a((C0235f) new C0253t(C0251r.f1959ci, this.f809h, C0247n.m1753a(local2.mo1167b()), this.f812k, typeId.f859c));
        m826a(local, true);
    }
    ...
    public <R> void invokeStatic(MethodId<?, R> methodId, Local<? super R> local, Local<?>... localArr) {
        m829a(C0251r.m1782a(methodId.mo1171b(true)), methodId, local, (Local) null, localArr);
    }
    ...
    public <D, V> void iput(FieldId<D, V> fieldId, Local<D> local, Local<V> local2) {
        m827a((C0235f) new C0253t(C0251r.m1818o((C0284d) local2.f846a.f858b), this.f809h, C0247n.m1754a(local2.mo1167b(), local.mo1167b()), this.f812k, fieldId.f838e));
    }
    ...
    public <T> void loadConstant(Local<T> local, T t) {
        ...
        if (e.mo1629b() == 1) {
            m827a((C0235f) new C0241j(e, this.f809h, local.mo1167b(), C0247n.f1778a, Constants.m836a(t)));
            return;
        }
        m827a((C0235f) new C0253t(e, this.f809h, C0247n.f1778a, this.f812k, Constants.m836a(t)));
        m826a((Local<?>) local, true);
    }
    ...
    public <T> void newArray(Local<T> local, Local<Integer> local2) {
        m827a((C0235f) new C0253t(C0251r.m1814m((C0284d) local.f846a.f858b), this.f809h, C0247n.m1753a(local2.mo1167b()), this.f812k, local.f846a.f859c));
        m826a((Local<?>) local, true);
    }
    ...
    public <T> void newInstance(Local<T> local, MethodId<T, Void> methodId, Local<?>... localArr) {
        ...
        m827a((C0235f) new C0253t(C0251r.f1897bY, this.f809h, C0247n.f1778a, this.f812k, methodId.f850a.f859c));
        m826a((Local<?>) local, true);
    ...
    public Label removeCatchClause(TypeId<? extends Throwable> typeId) {
        ...
        this.f812k = m823a(this.f810i);
        return this.f811j.remove(indexOf);
    }

    public void returnValue(Local<?> local) {
        if (!local.f846a.equals(this.f802a.f851b)) {
            throw new IllegalArgumentException("declared " + this.f802a.f851b + " but returned " + local.f846a);
        }
    ...
    public void returnVoid() {
        if (!this.f802a.f851b.equals(TypeId.VOID)) {
            throw new IllegalArgumentException("declared " + this.f802a.f851b + " but returned void");
        }
    ...
    public <V> void sget(FieldId<?, V> fieldId, Local<V> local) {
        m827a((C0235f) new C0253t(C0251r.m1820p((C0284d) local.f846a.f858b), this.f809h, C0247n.f1778a, this.f812k, fieldId.f838e));
        m826a((Local<?>) local, true);
    }

    public <V> void sput(FieldId<?, V> fieldId, Local<V> local) {
        m827a((C0235f) new C0253t(C0251r.m1822q((C0284d) local.f846a.f858b), this.f809h, C0247n.m1753a(local.mo1167b()), this.f812k, fieldId.f838e));
    }
