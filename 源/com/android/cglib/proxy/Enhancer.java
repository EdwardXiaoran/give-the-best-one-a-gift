...
public class Enhancer {
    ...
    private <S> void m2099a(DexMaker dexMaker, TypeId<?> typeId, TypeId<S> typeId2) {
        TypeId<Object[]> typeId3;
        FieldId<S, V> fieldId;
        Constructor[] constructorArr;
        TypeId<Class> typeId4;
        int i;
        DexMaker dexMaker2 = dexMaker;
        TypeId<S> typeId5 = typeId2;
        TypeId typeId6 = TypeId.get(MethodInterceptor.class);
        TypeId<MethodProxyExecuter> typeId7 = TypeId.get(MethodProxyExecuter.class);
        TypeId<Class> typeId8 = TypeId.get(Class.class);
        TypeId<Class[]> typeId9 = TypeId.get(Class[].class);
        TypeId<String> typeId10 = TypeId.get(String.class);
        TypeId<Object> typeId11 = TypeId.get(Object.class);
        TypeId<Object[]> typeId12 = TypeId.get(Object[].class);
        FieldId<S, V> field = typeId5.getField(typeId6, "methodInterceptor");
        dexMaker2.declare(field, 2, (Object) null);
        Constructor[] declaredConstructors = this.f2182b.getDeclaredConstructors();
        int length = declaredConstructors.length;
        TypeId<MethodProxyExecuter> typeId13 = typeId7;
        int i2 = 0;
        while (i2 < length) {
            FieldId<S, V> fieldId2 = field;
        ...
        TypeId<Object[]> typeId14 = typeId12;
        TypeId<Class> typeId15 = typeId8;
        Code declare = dexMaker2.declare(typeId5.getMethod(TypeId.VOID, EnhancerInterface.SET_METHOD_INTERCEPTOR_ENHANCER, typeId6), 1);
        FieldId<S, V> fieldId3 = field;
        declare.iput(fieldId3, declare.getThis(typeId5), declare.getParameter(0, typeId6));
        declare.returnVoid();
        ...
        Local<Object> newLocal = declare2.newLocal(typeId11);
        TypeId<Class> typeId16 = typeId15;
        Local<Class> newLocal2 = declare2.newLocal(typeId16);
        Local<S> local = declare2.getThis(typeId5);
        FieldId<S, V> fieldId4 = fieldId3;
        ...
        for (Method method : this.f2182b.getMethods()) {
            ...
            if (!name.contains(Const.SUBCLASS_SUFFIX) && !name.contains(Const.SUBCLASS_INVOKE_SUPER_SUFFIX) && (method.getModifiers() & 8) == 0 && (method.getModifiers() & 16) == 0 && (method.getModifiers() & Constants.ACC_NATIVE) == 0 && ((method.getModifiers() & 1024) != 0 || this.f2184d == null || this.f2184d.filter(method, name))) {
                try {
                    m2101a(dexMaker, typeId, typeId2, method, name, fieldId4);
                } catch (Exception e2) {
                    C0029a.m806a(e2);
                }
            }
    ...
    private void m2100a(DexMaker dexMaker, TypeId<?> typeId, TypeId<?> typeId2, Constructor constructor, FieldId<?, MethodInterceptor> fieldId) {
        TypeId[] typeIdArr;
        MethodId<?, Void> methodId;
        MethodId<?, Void> methodId2;
        Local[] localArr;
        ...
        declare.invokeDirect(methodId, (Local) null, local, localArr);
        declare.returnVoid();
    }
    ...
    private void m2101a(DexMaker dexMaker, TypeId<?> typeId, TypeId<?> typeId2, Method method, String str, FieldId<?, MethodInterceptor> fieldId) {
        TypeId<MethodProxyExecuter> typeId3;
        boolean z;
        MethodId<?, R> methodId;
        TypeId[] typeIdArr;
        Local<?> local;
        ...
        Local<?> local3;
        Local<?> local4;
        MethodId<?, R> methodId2;
        MethodId<?, R> methodId3;
        Local<?> local5;
        Class[] clsArr2;
        Local local6;
        Local<Object> local7;
        ...
        String str2 = str;
        TypeId<MethodInterceptor> typeId7 = TypeId.get(MethodInterceptor.class);
        TypeId<MethodProxyExecuter> typeId8 = TypeId.get(MethodProxyExecuter.class);
        TypeId typeId9 = TypeId.get(Class.class);
        TypeId<Class[]> typeId10 = TypeId.get(Class[].class);
        TypeId<String> typeId11 = TypeId.get(String.class);
        TypeId<Object> typeId12 = TypeId.get(Object.class);
        TypeId<Object[]> typeId13 = TypeId.get(Object[].class);
        ...
        Local<MethodInterceptor> newLocal3 = declare.newLocal(typeId7);
        Local local8 = local2;
        Local<String> newLocal4 = declare.newLocal(TypeId.get(String.class));
        Class<?> cls = returnType;
        Local newLocal5 = declare.newLocal(typeId9);
        TypeId<String> typeId16 = typeId11;
        Local newLocal6 = declare.newLocal(typeId9);
        TypeId<MethodInterceptor> typeId17 = typeId7;
        Local<Class[]> newLocal7 = declare.newLocal(typeId10);
        TypeId<Class[]> typeId18 = typeId10;
        Local<Object[]> newLocal8 = declare.newLocal(typeId13);
        TypeId<Object[]> typeId19 = typeId13;
        Local<Object> newLocal9 = declare.newLocal(typeId12);
        TypeId<Object> typeId20 = typeId12;
        Local<Object> newLocal10 = declare.newLocal(TypeId.OBJECT);
        Local<?> local9 = declare.getThis(typeId6);
        Local<Object> local10 = newLocal9;
        declare.iget(fieldId, newLocal3, local9);
        declare.loadConstant(newLocal4, str2);
        Local<String> local11 = newLocal4;
        ...
        if (z) {
            ...
            if (cls2.isPrimitive()) {
                ...
                Local<Object> local13 = newLocal10;
        ...
        if (z2) {
            ...
            local4 = local3;
            String str4 = str;
            methodId3 = typeId6.getMethod(typeId4, str4 + Const.SUBCLASS_INVOKE_SUPER_SUFFIX, new TypeId[0]);
            methodId2 = typeId.getMethod(typeId4, str4, new TypeId[0]);
        }
    ...
    public Class<?> create() {
        ...
        TypeId<EnhancerInterface> typeId3 = TypeId.get(EnhancerInterface.class);
