...
public class PullingLayout extends RelativeLayout {
        ...
        public void handleMessage(Message message) {
            ...
            if (!PullingLayout.this.f312k) {
                if (PullingLayout.this.f303b == 2 && PullingLayout.this.pullDownY <= PullingLayout.this.f308g) {
                    ...
                    float unused = PullingLayout.this.f307f = -PullingLayout.this.f309h;
                }
            ...
            if (PullingLayout.this.pullDownY > 0.0f) {
                ...
                float unused2 = PullingLayout.this.f307f = PullingLayout.this.f307f + PullingLayout.this.MOVE_SPEED;
            }
            if (PullingLayout.this.pullDownY < 0.0f) {
            ...
            if (PullingLayout.this.f307f > 0.0f) {
                float unused3 = PullingLayout.this.f307f = 0.0f;
    ...
    private class LoadingDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            ...
            if (PullingLayout.this.f297ad >= 360 && this.f347c == 0) {
                int unused = PullingLayout.this.f302ai = 8;
                int unused2 = PullingLayout.this.f301ah = -6;
            } else if (PullingLayout.this.f297ad <= 6) {
                int unused3 = PullingLayout.this.f301ah = 6;
                int unused4 = PullingLayout.this.f302ai = 2;
            }
            if (PullingLayout.this.f297ad < 360 || this.f347c == 0) {
                if (this.f347c == 0) {
                    int unused5 = PullingLayout.this.f297ad = PullingLayout.this.f297ad + PullingLayout.this.f301ah;
                    pullingLayout = PullingLayout.this;
                    p = PullingLayout.this.f298ae;
                    q = PullingLayout.this.f302ai;
                } else {
                    int unused6 = PullingLayout.this.f297ad = PullingLayout.this.f297ad + (PullingLayout.this.f301ah * 2);
                    pullingLayout = PullingLayout.this;
                    p = PullingLayout.this.f298ae;
                    q = PullingLayout.this.f302ai * 2;
                }
                int unused7 = pullingLayout.f298ae = p + q;
                int unused8 = PullingLayout.this.f298ae = PullingLayout.this.f298ae % 360;
            }
            ...
            if (PullingLayout.this.f297ad >= 360) {
                int unused9 = PullingLayout.this.f301ah = -6;
                int unused10 = PullingLayout.this.f302ai = 8;
                if (this.f347c == 1) {
                    Path path = new Path();
    ...
    private class PullDownDrawable extends Drawable {
        ...
        PullDownDrawable() {
            this.f361b.setStyle(Paint.Style.STROKE);
    ...
    private class PullUpDrawable extends Drawable {
        ...
        PullUpDrawable() {
            this.f363b.setStyle(Paint.Style.STROKE);
    ...
    private void m152a(Context context) {
        ...
        super.addView(this.f316o, new RelativeLayout.LayoutParams(-1, -1));
        this.f327z = new FrameLayout(this.f274E);
        super.addView(this.f327z, new RelativeLayout.LayoutParams(-1, -1));
        this.f321t = new FootView(this.f274E);
        super.addView(this.f321t, new RelativeLayout.LayoutParams(-1, -1));
        this.f327z = (FrameLayout) getChildAt(1);
        m173e();
        this.f310i = new MyTimer(this.f293a);
        this.f314m = new RotateAnimation(0.0f, 180.0f, 1, 0.5f, 1, 0.5f);
        this.f314m.setDuration(100);
        this.f314m.setRepeatCount(0);
        this.f314m.setFillAfter(true);
        this.f315n = new RotateAnimation(0.0f, 360.0f, 1, 0.5f, 1, 0.5f);
