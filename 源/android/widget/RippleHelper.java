        ...
        public void run() {
            ...
            switch (RippleHelper.this.f368b) {
                case 1:
                    ...
                    int unused = rippleHelper.f373g = c + d;
                    int unused2 = RippleHelper.this.f385s = Math.min(RippleHelper.this.f381o, RippleHelper.this.f373g / RippleHelper.this.f370d);
                    RippleHelper.this.f379m.postInvalidate();
                    return;
                case 2:
                    int unused3 = RippleHelper.this.f373g = RippleHelper.this.f373g + (RippleHelper.this.f370d * 4);
                    int unused4 = RippleHelper.this.f385s = Math.min(RippleHelper.this.f381o, (RippleHelper.this.f373g / RippleHelper.this.f370d) * 2);
                    RippleHelper.this.f379m.postInvalidate();
                    if (RippleHelper.this.f373g / RippleHelper.this.f369c >= 1) {
                        int unused5 = RippleHelper.this.f373g = RippleHelper.this.f369c;
                        int unused6 = RippleHelper.this.f385s = RippleHelper.this.f381o;
                        int unused7 = RippleHelper.this.f368b = 3;
                        return;
                    }
                    return;
                case 3:
                    int unused8 = RippleHelper.this.f385s = RippleHelper.this.f385s - Math.max(RippleHelper.this.f385s / 16, 4);
                    RippleHelper.this.f376j.setAlpha(RippleHelper.this.f385s);
                    RippleHelper.this.f379m.postInvalidate();
                    if (RippleHelper.this.f385s < 4) {
                        int unused9 = RippleHelper.this.f368b = 0;
                        return;
                    }
                    return;
                default:
                    int unused10 = RippleHelper.this.f373g = 0;
                    setEnabled(false);
                    return;
            }
        }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.f368b != 0) {
            ...
            while (true) {
                ...
                i3++;
                if (i3 >= 2) {
                    this.f376j.setShader(new RadialGradient(this.f377k, this.f378l, (float) m193a(6.0f), new int[]{1157627903, this.f383q, 1140850688}, (float[]) null, Shader.TileMode.MIRROR));
                    this.f376j.setStyle(Paint.Style.STROKE);
            ...
            this.f376j.setShader((Shader) null);
            this.f376j.setStyle(Paint.Style.FILL);
        }
    }
