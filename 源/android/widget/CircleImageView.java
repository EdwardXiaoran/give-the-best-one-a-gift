...
public class CircleImageView extends ImageView {
    ...
    /* renamed from: a */
    private static final ImageView.ScaleType f63a = ImageView.ScaleType.CENTER_CROP;

    /* renamed from: b */
    private static final Bitmap.Config f64b = Bitmap.Config.ARGB_8888;
    ...
    private void m29d() {
        if (!this.f81s) {
            ...
            this.f75m = new BitmapShader(this.f74l, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
            this.f68f.setAntiAlias(true);
            this.f68f.setShader(this.f75m);
            this.f69g.setStyle(Paint.Style.STROKE);
            this.f69g.setAntiAlias(true);
            this.f69g.setColor(this.f71i);
            this.f69g.setStrokeWidth((float) this.f72j);
            this.f70h.setStyle(Paint.Style.FILL);
