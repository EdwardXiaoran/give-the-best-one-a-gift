...
public class CardView extends FrameLayout implements CardViewDelegate {
    ...
    /* renamed from: a */
    private static final CardViewImpl f54a = (Build.VERSION.SDK_INT >= 21 ? new CardViewApi21() : Build.VERSION.SDK_INT >= 17 ? new CardViewJellybeanMr1() : new CardViewEclairMr1());
    ...
    static class CardViewEclairMr1 implements CardViewImpl {
        ...
        public void initStatic() {
            RoundRectDrawableWithShadow.f401c = new RoundRectDrawableWithShadow.RoundRectHelper() {
    ...
    public CardView(Context context) {
        super(context);
        m22a(context, (AttributeSet) null, 0);
    }
    ...
    public void onMeasure(int i, int i2) {
        if (!(f54a instanceof CardViewApi21)) {
            ...
            if (mode == Integer.MIN_VALUE || mode == 1073741824) {
                i = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil((double) f54a.getMinWidth(this)), View.MeasureSpec.getSize(i)), mode);
            }
            int mode2 = View.MeasureSpec.getMode(i2);
            if (mode2 == Integer.MIN_VALUE || mode2 == 1073741824) {
                i2 = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil((double) f54a.getMinHeight(this)), View.MeasureSpec.getSize(i2)), mode2);
            }
        }
