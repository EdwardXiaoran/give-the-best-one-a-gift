...
public class ToolBar extends LinearLayout {
    ...
    private void m231a(Context context) {
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(this.f441l, this.f441l);
        setMinimumHeight(this.f441l);
        this.f432c = new ImageView(context2);
        this.f432c.setScaleType(ImageView.ScaleType.FIT_CENTER);
        this.f432c.setVisibility(8);
        super.addView(this.f432c, layoutParams);
        this.f433d = new ImageView(context2);
        this.f433d.setScaleType(ImageView.ScaleType.FIT_CENTER);
        ...
        super.addView(linearLayout, new LinearLayout.LayoutParams(-1, this.f441l, 1.0f));
        ...
        linearLayout.addView(this.f430a, new LinearLayout.LayoutParams(-1, m229a(26.0f)));
        this.f431b = new TextView(context2);
        this.f431b.setTextSize(1, 14.0f);
        this.f431b.setSingleLine(true);
        this.f431b.setVisibility(8);
        linearLayout.addView(this.f431b, new LinearLayout.LayoutParams(-1, m229a(20.0f)));
        this.f435f = new LinearLayout(context2);
        super.addView(this.f435f, new LinearLayout.LayoutParams(-2, this.f441l));
        this.f434e = new ImageView(context2);
        this.f434e.setScaleType(ImageView.ScaleType.FIT_CENTER);
        ...
        Bitmap createBitmap = Bitmap.createBitmap(this.f441l, this.f441l, Bitmap.Config.ARGB_4444);
        ...
        Bitmap createBitmap2 = Bitmap.createBitmap(this.f441l, this.f441l, Bitmap.Config.ARGB_4444);
        ...
        this.f432c.setOnClickListener(new View.OnClickListener() {
        ...
        this.f433d.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
        ...
        this.f434e.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
        ...
        this.f436g.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
