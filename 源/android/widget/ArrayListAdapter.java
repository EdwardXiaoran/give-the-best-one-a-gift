...
public class ArrayListAdapter<T> extends BaseAdapter implements Filterable {
    ...
    /* renamed from: i */
    private ArrayListAdapter<T>.ArrayFilter f49i;
    ...
    private class ArrayFilter extends Filter {
        ...
        public Filter.FilterResults performFiltering(CharSequence charSequence) {
            ...
            if (ArrayListAdapter.this.f48h == null) {
                synchronized (ArrayListAdapter.this.f42b) {
                    ArrayList unused = ArrayListAdapter.this.f48h = new ArrayList(ArrayListAdapter.this.f41a);
                }
            } else if (TextUtils.isEmpty(charSequence)) {
                filterResults.values = new ArrayList(ArrayListAdapter.this.f48h);
                filterResults.count = ArrayListAdapter.this.f48h.size();
                ArrayList unused2 = ArrayListAdapter.this.f48h = null;
        ...
        public void publishResults(CharSequence charSequence, Filter.FilterResults filterResults) {
            ArrayList unused = ArrayListAdapter.this.f41a = (ArrayList) filterResults.values;
    ...
    public ArrayListAdapter(Context context) {
        m16a(context, 17367043, 0, new ArrayList());
    }

    public ArrayListAdapter(Context context, int i) {
        m16a(context, i, 0, new ArrayList());
    }

    public ArrayListAdapter(Context context, int i, int i2) {
        m16a(context, i, i2, new ArrayList());
    }
