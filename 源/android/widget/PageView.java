...
public class PageView extends ViewGroup {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "FragmentPage.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.f267a + "}";
        }
    ...
    private int m109a(int i, float f, int i2, int i3) {
        ...
        return this.f234e.size() > 0 ? Math.max(this.f234e.get(0).f258b, Math.min(i, this.f234e.get(this.f234e.size() - 1).f258b)) : i;
    }
    ...
    private void m114a(ItemInfo itemInfo, int i, ItemInfo itemInfo2) {
        ...
        int i7 = i - 1;
        while (i7 >= 0) {
            ItemInfo itemInfo5 = this.f234e.get(i7);
        ...
        int i9 = i + 1;
        while (i9 < size2) {
            ItemInfo itemInfo6 = this.f234e.get(i9);
    ...
    private boolean m117a(float f, float f2) {
        if (f >= ((float) this.f203E) || f2 <= 0.0f) {
            return f > ((float) (getWidth() - this.f203E)) && f2 < 0.0f;
        }
        return true;
    }
    ...
    private void m118b(int i, float f, int i2) {
        ...
        if (this.f223ab != null) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                OnPageChangeListener onPageChangeListener = this.f223ab.get(i3);
    ...
    private void m119b(boolean z) {
        ...
        for (int i = 0; i < childCount; i++) {
            getChildAt(i).setLayerType(z ? 2 : 0, (Paint) null);
        }
    }
    ...
    private boolean m120b(float f) {
        ...
        ItemInfo itemInfo = this.f234e.get(0);
        boolean z2 = true;
        ItemInfo itemInfo2 = this.f234e.get(this.f234e.size() - 1);
        if (itemInfo.f258b != 0) {
    ...
    private void m123d(int i) {
        ...
        if (this.f223ab != null) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                OnPageChangeListener onPageChangeListener = this.f223ab.get(i2);
                if (onPageChangeListener != null) {
    ...
    private ItemInfo m129j() {
        ...
        while (i2 < this.f234e.size()) {
            ItemInfo itemInfo2 = this.f234e.get(i2);
            if (!z && itemInfo2.f258b != (i = i3 + 1)) {
            ...
            if (scrollX < f4 || i2 == this.f234e.size() - 1) {
                return itemInfo2;
            }
            i3 = itemInfo2.f258b;
            f3 = itemInfo2.f260d;
    ...
    public void mo308a(int r19) {
        ...
        L_0x0011:
            int r4 = r0.f239j
            android.widget.PageView$ItemInfo r4 = r0.mo319b((int) r4)
            r0.f239j = r1
            goto L_0x001c
        L_0x001a:
            r2 = 2
        ...
        L_0x0073:
            ...
            int r9 = r0.f239j
            android.widget.PageView$ItemInfo r9 = r0.mo305a((int) r9, (int) r8)
        L_0x007d:
        ...
        L_0x00dd:
            int r10 = r11 + 1
            android.widget.PageView$ItemInfo r10 = r0.mo305a((int) r6, (int) r10)
            float r10 = r10.f260d
            float r8 = r8 + r10
            int r15 = r15 + 1
            if (r11 < 0) goto L_0x00f3
        ...
        L_0x0155:
            ...
            goto L_0x014a
        L_0x0169:
            android.widget.PageView$ItemInfo r6 = r0.mo305a((int) r8, (int) r5)
            int r5 = r5 + 1
            float r6 = r6.f260d
            float r3 = r3 + r6
            java.util.ArrayList<android.widget.PageView$ItemInfo> r6 = r0.f234e
        ...
        L_0x017b:
            goto L_0x0121
        L_0x017c:
            r0.m114a((android.widget.PageView.ItemInfo) r9, (int) r15, (android.widget.PageView.ItemInfo) r4)
        L_0x017f:
            android.widget.BasePageAdapter r1 = r0.f238i
            int r3 = r0.f239j
        ...
        L_0x0196:
            ...
            android.widget.PageView$ItemInfo r4 = r0.mo306a((android.view.View) r4)
        ...
        L_0x01c2:
            ...
            android.widget.PageView$ItemInfo r3 = r0.mo320b((android.view.View) r1)
            goto L_0x01d7
        L_0x01d6:
            r3 = 0
        L_0x01d7:
        ...
        L_0x01e0:
            ...
            android.widget.PageView$ItemInfo r4 = r0.mo306a((android.view.View) r3)
        ...
        if (view2 instanceof ViewGroup) {
            ...
            for (int childCount = viewGroup.getChildCount() - 1; childCount >= 0; childCount--) {
                ...
                if (i5 >= childAt.getLeft() && i5 < childAt.getRight() && (i4 = i3 + scrollY) >= childAt.getTop() && i4 < childAt.getBottom()) {
                    if (mo313a(childAt, true, i, i5 - childAt.getLeft(), i4 - childAt.getTop())) {
                        return true;
                    }
                }
            }
    ...
    public void addFocusables(ArrayList<View> arrayList, int i, int i2) {
        ...
        if (descendantFocusability != 393216) {
            for (int i3 = 0; i3 < getChildCount(); i3++) {
                ...
                if (childAt.getVisibility() == 0 && (a = mo306a(childAt)) != null && a.f258b == this.f239j) {
    ...
    public ItemInfo mo319b(int i) {
        for (int i2 = 0; i2 < this.f234e.size(); i2++) {
            ItemInfo itemInfo = this.f234e.get(i2);
            if (itemInfo.f258b == i) {
                return itemInfo;
            }
        }
    ...
    public boolean canScrollHorizontally(int i) {
        ...
        int clientWidth = getClientWidth();
        int scrollX = getScrollX();
        return i < 0 ? scrollX > ((int) (((float) clientWidth) * this.f249t)) : i > 0 && scrollX < ((int) (((float) clientWidth) * this.f250u));
    }
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        for (int i = 0; i < childCount; i++) {
            View childAt = getChildAt(i);
            if (childAt.getVisibility() == 0 && (a = mo306a(childAt)) != null && a.f258b == this.f239j && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                return true;
            }
        }
        return false;
    ...
    public int getChildDrawingOrder(int i, int i2) {
        ...
        return ((LayoutParams) this.f230ai.get(i2).getLayoutParams()).f265d;
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.f245p > 0 && this.f246q != null && this.f234e.size() > 0 && this.f238i != null) {
            ...
            int i3 = this.f234e.get(size - 1).f258b;
            while (i2 < i3) {
                while (i2 > itemInfo.f258b && i < size) {
                    i++;
                    itemInfo = this.f234e.get(i);
                }
                if (i2 == itemInfo.f258b) {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i18 = 0; i18 < childCount; i18++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (a = mo306a(childAt2)) != null) {
                    float f = (float) i17;
                    int i19 = ((int) (a.f261e * f)) + i12;
                    if (layoutParams2.f263b) {
                        layoutParams2.f263b = false;
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.f262a), 1073741824), View.MeasureSpec.makeMeasureSpec((i8 - i11) - i9, 1073741824));
                    }
    ...
    public boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        while (i3 != i4) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() == 0 && (a = mo306a(childAt)) != null && a.f258b == this.f239j && childAt.requestFocus(i, rect)) {
                return true;
            }
            i3 += i2;
        }
    ...
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        ...
        L_0x0039:
            goto L_0x0142
        L_0x003b:
            r7.m113a((android.view.MotionEvent) r8)
            int r0 = r7.f209K
        ...
        L_0x005c:
            ...
            int r8 = r7.f239j
            r7.m112a((int) r8, (boolean) r1, (int) r2, (boolean) r2)
            goto L_0x011d
        L_0x0067:
            boolean r0 = r7.f200B
        ...
        L_0x00da:
            ...
            float r8 = r8 - r2
            int r8 = (int) r8
            int r8 = r7.m109a((int) r5, (float) r3, (int) r0, (int) r8)
            r7.mo312a((int) r8, (boolean) r1, (boolean) r1, (int) r0)
        L_0x011d:
            boolean r2 = r7.m128i()
            goto L_0x0142
        L_0x0122:
    ...
    public void setChildrenDrawingOrderEnabledCompat(boolean z) {
        if (Build.VERSION.SDK_INT >= 7) {
            if (this.f228ag == null) {
                ...
                try {
                    this.f228ag = cls.getDeclaredMethod("setChildrenDrawingOrderEnabled", new Class[]{Boolean.TYPE});
    ...
    public void setOffscreenPageLimit(int i) {
        if (i < 1) {
            Log.w("PageView", "Requested offscreen page limit " + i + " too small; defaulting to " + 1);
            i = 1;
        }
        if (i != this.f199A) {
            this.f199A = i;
