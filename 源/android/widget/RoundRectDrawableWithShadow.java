...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, int i, float f, float f2, float f3) {
        ...
        this.f404e.setStyle(Paint.Style.FILL);
    ...
    private void m217f() {
        ...
        this.f408i.setFillType(Path.FillType.EVEN_ODD);
        ...
        this.f404e.setShader(new RadialGradient(0.0f, 0.0f, this.f407h + this.f411l, new int[]{this.f414o, this.f414o, this.f415p}, new float[]{0.0f, f, 1.0f}, Shader.TileMode.CLAMP));
        this.f405f.setShader(new LinearGradient(0.0f, (-this.f407h) + this.f411l, 0.0f, (-this.f407h) - this.f411l, new int[]{this.f414o, this.f414o, this.f415p}, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.CLAMP));
        this.f405f.setAntiAlias(false);
    }
