...
public class BshMethod implements Serializable {
    ...
    BshMethod(Method method, Object obj) {
        this(method.getName(), method.getReturnType(), (String[]) null, method.getParameterTypes(), (BSHBlock) null, (NameSpace) null, (Modifiers) null);
        this.f519i = method;
        this.f520j = obj;
    }
    ...
    private Object m310b(Object[] objArr, Interpreter interpreter, CallStack callStack, SimpleNode simpleNode, boolean z) {
        ...
        while (true) {
            ...
            if (i >= this.f517g) {
                ...
                boolean z2 = eval instanceof ReturnControl;
                Object obj = eval;
                if (z2) {
                    returnControl = eval;
                    if (returnControl.kind == 46) {
                        Object obj2 = returnControl.value;
                        obj = obj2;
    ...
    public Object invoke(Object[] objArr, Interpreter interpreter) {
        return mo685a(objArr, interpreter, (CallStack) null, (SimpleNode) null, false);
    }
