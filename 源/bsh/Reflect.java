...
class Reflect {
    ...
    private static Object m729a(Class cls, Object obj, String str, boolean z) {
        try {
            ...
            return Primitive.wrap(b.get(obj), (Class) b.getType());
    ...
    static Object m731a(Method method, Object obj, Object[] objArr) {
        ...
        try {
            ...
            return Primitive.wrap(invoke, (Class) method.getReturnType());
    ...
    protected static Method m736a(BshClassManager bshClassManager, Class cls, String str, Class[] clsArr, boolean z) {
        ...
        if (bshClassManager == null) {
            ...
            method = bshClassManager.mo653a(cls, str, clsArr, z);
        }
        if (method != null) {
            return method;
        }
        ...
        try {
            Method a = m737a(cls, str, clsArr, z2);
            m742a(a, z, cls);
            if (a != null && !z2) {
                try {
                    ReflectManager.RMSetAccessible(a);
            ...
            bshClassManager.cacheResolvedMethod(cls, clsArr, a);
            return a;
    ...
    private static java.util.Vector m739a(java.lang.Class r3, java.lang.String r4, int r5, boolean r6, java.util.Vector r7) {
        ...
        L_0x0007:
            ...
            boolean r0 = m743a((java.lang.Class) r3)
        ...
        L_0x0018:
            m740a((java.lang.reflect.Method[]) r0, (java.lang.String) r4, (int) r5, (boolean) r6, (java.util.Vector) r7)
        L_0x001b:
        ...
        L_0x0020:
            ...
            m739a((java.lang.Class) r3, (java.lang.String) r4, (int) r5, (boolean) r6, (java.util.Vector) r7)
        L_0x002c:
            return r7
        L_0x002d:
            r2 = r0[r1]
            m739a((java.lang.Class) r2, (java.lang.String) r4, (int) r5, (boolean) r6, (java.util.Vector) r7)
            int r1 = r1 + 1
            goto L_0x0020
        */
    ...
    public static Object getIndex(Object obj, int i) {
        ...
        try {
            return Primitive.wrap(Array.get(obj, i), (Class) obj.getClass().getComponentType());
    ...
    public static Object getObjectFieldValue(Object obj, String str) {
        ...
        try {
            return m729a((Class) obj.getClass(), obj, str, false);
        } catch (ReflectError e) {
    ...
    public static Object getObjectProperty(Object obj, String str) {
        ...
        Exception exc2 = null;
        try {
            method = m735a((BshClassManager) null, obj.getClass(), obj, m732a("get", str), objArr, false);
            exc = null;
        } catch (Exception e) {
            exc = e;
            method = null;
        ...
        if (method == null) {
            try {
                Method a = m735a((BshClassManager) null, obj.getClass(), obj, m732a("is", str), objArr, false);
                try {
    ...
    public static Object invokeStaticMethod(BshClassManager bshClassManager, Class cls, String str, Object[] objArr) {
        ...
        return m731a(m735a(bshClassManager, cls, (Object) null, str, objArr, true), (Object) null, objArr);
    }
    ...
    public static void setObjectProperty(Object obj, String str, Object obj2) {
        ...
        Interpreter.debug("property access: ");
        try {
            m731a(m735a((BshClassManager) null, obj.getClass(), obj, a, objArr, false), obj, objArr);
        } catch (InvocationTargetException e) {
            StringBuffer stringBuffer = new StringBuffer();
