...
public class NameSpace implements BshClassManager.Listener, NameSource, Serializable {
    ...
    public NameSpace(BshClassManager bshClassManager, String str) {
        this((NameSpace) null, bshClassManager, str);
    }
    ...
    public NameSpace(NameSpace nameSpace, String str) {
        this(nameSpace, (BshClassManager) null, str);
    }
    ...
    private Class m384e(String str) {
        ...
        if (!classManager.mo660c() || (b = classManager.mo657b(str)) == null) {
            return null;
        }
        return m385f(b);
    }
    ...
    public BshMethod mo850a(String str, Class[] clsArr) {
        if (this.f632n != null) {
            for (int i = 0; i < this.f632n.size(); i++) {
                ...
                Method a = Reflect.m736a(getClassManager(), (Class) elementAt.getClass(), str, clsArr, false);
                if (a != null) {
        ...
        for (int i2 = 0; i2 < this.f633o.size(); i2++) {
            ...
            if (a2 != null) {
                return new BshMethod(a2, (Object) null);
            }
        }
        return null;
    }
    ...
    public Variable mo851a(String str) {
        if (this.f632n != null) {
            for (int i = 0; i < this.f632n.size(); i++) {
                Object elementAt = this.f632n.elementAt(i);
                Field a = Reflect.m734a((Class) elementAt.getClass(), str, false);
                if (a != null) {
                    return new Variable(str, (Class) a.getType(), new LHS(elementAt, a));
                }
            }
        }
        if (this.f633o == null) {
        ...
        for (int i2 = 0; i2 < this.f633o.size(); i2++) {
            ...
            if (a2 != null) {
                return new Variable(str, (Class) a2.getType(), new LHS(a2));
            }
        }
        return null;
    }
    ...
    public BshClassManager getClassManager() {
        ...
        this.f635q = BshClassManager.createClassManager((Interpreter) null);
        return this.f635q;
    }
    ...
    public BshMethod getMethod(String str, Class[] clsArr, boolean z) {
        ...
        if (!(a != null || this.f629k == null || (obj = this.f629k.get(str)) == null)) {
    ...
    public Object invokeMethod(String str, Object[] objArr, Interpreter interpreter) {
        return invokeMethod(str, objArr, interpreter, (CallStack) null, (SimpleNode) null);
    }
    ...
    public void prune() {
        if (this.f635q == null) {
            mo854a(BshClassManager.createClassManager((Interpreter) null));
        }
