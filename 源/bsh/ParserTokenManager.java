...
public class ParserTokenManager implements ParserConstants {
    ...
    private static final boolean m682b(int i, int i2, int i3, long j, long j2) {
        return i != 0 ? (f660b[i2] & j) != 0 : (f659a[i3] & j2) != 0;
    }
    ...
    private static final boolean m688c(int i, int i2, int i3, long j, long j2) {
        if (i == 0) {
            return (f662d[i3] & j2) != 0;
        }
        if (i == 51) {
            return (f665g[i3] & j2) != 0;
        }
        if (i == 61) {
            return (f666h[i3] & j2) != 0;
        }
        switch (i) {
            case 48:
                return (f663e[i3] & j2) != 0;
            case 49:
                return (f664f[i3] & j2) != 0;
            default:
                return (f661c[i2] & j) != 0;
        }
    }
        ...
        while (true) {
            try {
                ...
                if (this.f678t != Integer.MAX_VALUE) {
                    ...
                    throw new TokenMgrError(z, this.f673o, i2, i, str, this.f672n, 0);
                }
