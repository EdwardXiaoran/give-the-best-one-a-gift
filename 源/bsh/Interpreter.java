...
public class Interpreter implements ConsoleInterface, Serializable, Runnable {
    ...
    public Interpreter() {
        this(new StringReader(BuildConfig.FLAVOR), System.out, System.err, false, (NameSpace) null);
        this.f577l = true;
        mo768a("bsh.evalOnly", new Primitive(true));
    }

    public Interpreter(ConsoleInterface consoleInterface) {
        this(consoleInterface, (NameSpace) null);
    }
    ...
    public Interpreter(Reader reader, PrintStream printStream, PrintStream printStream2, boolean z, NameSpace nameSpace) {
        this(reader, printStream, printStream2, z, nameSpace, (Interpreter) null, (String) null);
    }
    ...
    public static void invokeMain(Class cls, String[] strArr) {
        ...
        clsArr[0] = cls2;
        Method a = Reflect.m736a((BshClassManager) null, cls, "main", clsArr, true);
        if (a != null) {
            a.invoke((Object) null, new Object[]{strArr});
        }
    }
    ...
    public java.lang.Object eval(java.io.Reader r11, bsh.NameSpace r12, java.lang.String r13) {
        ...
        L_0x008b:
            ...
            r11.push(r12)
        L_0x00a7:
            java.lang.Object r11 = bsh.Primitive.unwrap((java.lang.Object) r3)
            return r11
        L_0x00ac:
        ...
        L_0x0162:
            ...
            r3.mo745a((bsh.SimpleNode) r1)     // Catch:{ all -> 0x00fd }
        L_0x016b:
    ...
    public File pathToFile(String str) {
        ...
        if (!file.isAbsolute()) {
            StringBuffer stringBuffer = new StringBuffer();
            stringBuffer.append((String) mo766a("bsh.cwd"));
            stringBuffer.append(File.separator);
            stringBuffer.append(str);
    ...
    public void run() {
        ...
        L_0x000c:
            ...
            r8.eval((java.lang.String) r0)     // Catch:{ EvalError -> 0x0016 }
            goto L_0x001b
        L_0x0016:
        ...
        L_0x00ea:
            ...
            r2.mo984b((java.io.Reader) r5)     // Catch:{ all -> 0x00e3 }
        ...
        L_0x024e:
            ...
            java.io.Reader r5 = r8.f571f     // Catch:{ all -> 0x00e3 }
            r4.mo981a((java.io.Reader) r5)     // Catch:{ all -> 0x00e3 }
            bsh.JJTParserState r4 = r8.m345d()
            r4.mo801a()
            int r4 = r0.depth()
            if (r4 <= r3) goto L_0x0024
