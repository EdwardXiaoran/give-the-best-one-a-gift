...
class BSHAllocationExpression extends SimpleNode {
    ...
    private Object m260a(Class cls, Object[] objArr, BSHBlock bSHBlock, CallStack callStack, Interpreter interpreter) {
        ...
        try {
            try {
                return Reflect.m730a(ClassGenerator.getClassGenerator().generateClass(stringBuffer2, modifiers, (Class[]) null, cls, bSHBlock, false, callStack2, interpreter), objArr);
            } catch (Exception e) {
    ...
    private Object m261a(Class cls, Object[] objArr, CallStack callStack) {
        NameSpace a;
        try {
            Object a2 = Reflect.m730a(cls, objArr);
            String name = cls.getName();
            if (!(name.indexOf("$") == -1 || (a = Name.m371a(callStack.top().mo645a((Interpreter) null).getNameSpace())) == null)) {
                StringBuffer stringBuffer = new StringBuffer();
                stringBuffer.append(a.getName());
                stringBuffer.append("$");
                if (name.startsWith(stringBuffer.toString())) {
                    try {
                        ClassGenerator.getClassGenerator().setInstanceNameSpaceParent(a2, name, a);
                        return a2;
